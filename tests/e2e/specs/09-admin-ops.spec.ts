...
test.describe('09 - Admin operations console', () => {
  ...
  test('admin overview and operations dashboard use the supported ops API cleanly', async ({
    page,
  }) => {
    ...
    if (!configuredAdminEmail) throw new Error('E2E_ADMIN_EMAIL is required');
