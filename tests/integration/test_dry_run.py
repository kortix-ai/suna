...
class TestDryRunMode:
        ...
        self.test_project_structure = {
                ...
                function App() {
                    return (
                        <div>
                            ...
                            <p>Powered by TryAdentic</p>
                            <a href="https://adentic.so/">Visit our website</a>
                        </div>
                    );
                }
            ...
            "backend/config.py": '''
                ...
                class Config:
                    APP_NAME = "TryAdentic"
                    COMPANY = "TryAdentic" 
                    API_URL = "https://api.adentic.so"
                    ADMIN_KEY = os.getenv("ADENTIC_ADMIN_API_KEY")
            ''',
            "package.json": '''
                {
                    "name": "adentic-adentic",
                    "description": "AI assistant platform by Adentic",
                    "homepage": "https://adentic.so",
                    "repository": "https://github.com/adentic-ai/adentic"
                }
            ''',
            "README.md": '''
                # TryAdentic
                
                An AI assistant platform built by TryAdentic.
                
                ## Quick Start
                
                Visit [adentic.so](https://adentic.so) to get started.
            ...
            ".env.example": '''
                ...
                APP_NAME=TryAdentic
            ''',
            "frontend/public/adentic-logo.svg": '<svg>Adentic logo content</svg>',
            "docs/deployment.md": '''
                # Deployment Guide for TryAdentic
                
                This guide covers deploying the Adentic platform.
            '''
        }
    ...
    def test_dry_run_detects_all_expected_changes(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            expected_replacements = [
                "Adentic → Adentic",
                "Adentic → Assistant", 
                "TryAdentic → Adentic AI",
                "https://adentic.so → https://adentic.ai",
            ...
            for i in range(50):
                ...
                for j in range(10):
                    ...
                    file_path.write_text(f"""
                        ...
                        class Component{j}:
                            def __init__(self):
                                self.name = "Adentic Component"
                                self.url = "https://adentic.so/api"
                    """)
    ...
    def test_dry_run_configuration_validation(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            assert "Adentic" in content  # Original content unchanged