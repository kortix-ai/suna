...
- Product objects (project, session, sandbox, agent, skill, connector, secret, channel, trigger, memory, change request) are common nouns — lowercase in prose, capitalized only at sentence start or as table/UI labels.
