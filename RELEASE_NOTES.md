...
- **Standard sandbox runtime.** Sandboxes run as the `kortix` user with pinned Node.js, pnpm, npm, Python, uv, OpenCode, and browser tooling. User-local paths, repository ownership, runtime documentation, and warmup checks remain consistent across providers.
