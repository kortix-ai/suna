...
- **Security dependencies.** Next.js is 15.5.21, `fast-uri` is 3.1.4, `@hono/node-server` is 2.0.10, `sharp` is 0.35.0, and `fast-xml-parser` is 5.10.1. The release also updates Axios, SVGO, DOMPurify, Pillow, GitHub Actions, and related transitive dependencies.
