...
class TestImageReplacer:
    ...
    def setup_method(self):
        ...
        self.expected_image_mapping = {
            "frontend/public/kortix-logo.svg": "adentic-logo.svg",
            "frontend/public/kortix-logo-white.svg": "adentic-logo-white.svg",
            "frontend/public/kortix-symbol.svg": "adentic-symbol.svg",
            ...
            "apps/mobile/assets/images/kortix-logo-square.svg": "adentic-logo-square.svg"
        }
    ...
    def test_get_files_to_rename_for_adentic(self):
        ...
        # Should include files with 'kortix' in the name
        kortix_files = [f for f in files_to_rename if 'kortix' in f.lower()]
        assert len(kortix_files) > 0
        
        # Check specific files
        expected_renames = [
            "frontend/public/kortix-logo.svg",
            "frontend/public/kortix-logo-white.svg", 
            "frontend/public/kortix-symbol.svg",
            "apps/mobile/assets/images/kortix-logo-square.svg"
        ]
    ...
    def test_generate_new_filename_for_adentic(self):
        ...
        test_cases = [
            ("kortix-logo.svg", "adentic-logo.svg"),
            ("kortix-logo-white.svg", "adentic-logo-white.svg"),
            ("kortix-symbol.svg", "adentic-symbol.svg"),
            ("kortix-logo-square.svg", "adentic-logo-square.svg"),
            ("KORTIX-BANNER.png", "ADENTIC-BANNER.png"),
            ("app-kortix-icon.ico", "app-adentic-icon.ico")
        ]
    ...
    def test_rename_image_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            old_file_path = tmp_path / "kortix-logo.svg"
    ...
    def test_process_all_images(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            (frontend_public / "kortix-logo.svg").write_text('<svg>Old logo</svg>')
            ...
            with patch.object(self.image_replacer, 'get_image_replacement_mapping') as mock_mapping:
                mock_mapping.return_value = {
                    str(frontend_public / "kortix-logo.svg"): "adentic-logo.svg",
    ...
    def test_component_file_processing(self):
        ...
        import KortixLogo from './kortix-logo.svg';
        ...
        assert "kortix" not in result.lower()