...
class TestReportGenerator:
    ...
    def setup_method(self):
        ...
        self.sample_changes = [
            ...
            Change(
                ...
                change_type="IMAGE",
                old_value="kortix-logo.svg",
                new_value="adentic-logo.svg",
                details="Logo replacement"
            ),
            Change(
                file_path="frontend/src/components/sidebar/kortix-logo.tsx",
                change_type="RENAME",
                old_value="kortix-logo.tsx",
    ...
    def test_generate_adentic_specific_report_sections(self):
        ...
        assert "Kortix → Adentic" in str(brand_transformation)
        assert "Suna → Assistant" in str(brand_transformation)
