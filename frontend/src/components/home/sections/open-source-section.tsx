  ...
  const items = [
    {
      ...
      title: 'Security',
      description: 'Built with enterprise-grade security standards including GDPR compliance, ISO 27001 certification, and SOC 2 Type II attestation.',
              ...
              {item.showComplianceInfo && (
                <div className="flex flex-col gap-4 mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold bg-green-100 border-green-200 text-green-800 dark:bg-green-900/20 dark:border-green-800/30 dark:text-green-300">
                      GDPR Compliant
                    </span>
                    <span className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold bg-blue-100 border-blue-200 text-blue-800 dark:bg-blue-900/20 dark:border-blue-800/30 dark:text-blue-300">
                      ISO 27001
                    </span>
                    <span className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold bg-purple-100 border-purple-200 text-purple-800 dark:bg-purple-900/20 dark:border-purple-800/30 dark:text-purple-300">
                      SOC 2 Type II
                    </span>
                  </div>
                </div>
