...
const capabilities = [
  ...
  },
  {
    ...
    description: 'Kusor never sleeps. Schedule tasks to run overnight, on weekends, or whenever you need work done without being there.',
        ...
        <div className="max-w-6xl mx-auto border-l border-r border-border">
          <SectionHeader>
            <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-center text-balance pb-1">
              What Can Kusor Do For You?
            </h2>
            <p className="text-muted-foreground text-center text-balance font-medium">
              From content creation to data analysis, Kusor handles the work that takes you hours in just minutes.
            </p>
          </SectionHeader>
