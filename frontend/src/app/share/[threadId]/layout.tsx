...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | TryAdentic',
    description: 'Replay this Agent conversation on TryAdentic',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | TryAdentic';
    const description =
      projectData.description ||
      'Replay this Agent conversation on TryAdentic';
