...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Adentic Adentic',
    description: 'Replay this Agent conversation on Adentic Adentic',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Adentic Adentic';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Adentic Adentic';
