        ...
        <div className="mb-6">
          <CodeBlock 
            data={[{
              language: "bash",
              filename: "terminal",
              code: `git clone https://github.com/adentic-ai/adentic.git
cd adentic`
            }]}
            defaultValue="bash"
          >
      ...
      <DocsBody className="mb-8">
        <h2 id="step-5-start">Step 5: Start Adentic</h2>
...
docker compose down`
      ...
      <DocsBody className="mb-8">
        ...
        <p className="mb-4">You should see the Adentic dashboard where you can start chatting with Adentic or create your own agents.</p>
