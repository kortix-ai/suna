  ...
  return (
    <>
      <UnifiedUpgradeDialog
        ...
        icon={Crown}
        title="Unlock the Full Adentic Experience"
        description="Upgrade to unlock Adentic's full potential. Access our most powerful AI models and enhanced capabilities."
        theme="primary"
        size="sm"
