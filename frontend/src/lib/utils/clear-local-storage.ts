export const clearUserLocalStorage = () => {
  ...
  try {
    ...
    // localStorage.removeItem('adentic-preferred-model-v3');
    localStorage.removeItem('customModels');
    localStorage.removeItem('adentic-model-selection-v2');
    ...
    localStorage.removeItem('adentic_upgrade_dialog_displayed');
