...
| --- | ------------------------------------------------------- | ----------- | ---------- | ------------ | ------------------------ |
| 0   | Docs: spec, plan, `AGENTS.md`, prompt, this file        | **DONE**    | `01AzJBSa` | 2026-07-10   | *(pending first commit)* |
| 1   | Assert the two export maps agree                        | NOT STARTED | —          | —            | —                        |
| 2   | Install smoke test — pack, install, import              | NOT STARTED | —          | —            | —                        |
