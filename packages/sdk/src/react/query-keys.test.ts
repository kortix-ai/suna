...
describe('qk.project', () => {
  ...
  test('every project-scoped key is prefixed by scope', () => {
    ...
    const scoped = [
      ...
      qk.project.tasks(id),
      qk.project.task(id, 'task_1'),
      qk.project.taskEvidence(id, 'task_1'),
      qk.project.taskBlockers(id, 'task_1'),
      qk.project.taskEvents(id, 'task_1'),
      qk.project.taskSessions(id, 'task_1'),
