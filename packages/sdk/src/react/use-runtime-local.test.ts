...
} from './use-runtime-local';

describe('Runtime local model selection scoping', () => {
  ...
  test('keeps native mode for v0.9.68 legacy provider-list responses', () => {
    expect(
      modelProviderMode({
        providers: [{ id: 'opencode', name: 'Runtime', models: {} }],
  ...
  test('formats native Runtime models correctly for command and prompt calls', () => {
