 ...
 * Runtime SDK client + caches are global. Without scoping, switching from
 ...
 *
 * `session(id)` / `messages(id)` stay global: runtime session ids are unique
...
export function clearProjectRuntimeProviderCache(projectId: string): void {
