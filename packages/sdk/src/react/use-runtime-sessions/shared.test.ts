...
// ============================================================================
// getLSCache / setLSCache / clearProjectRuntimeProviderCache — the localStorage-backed
...
describe('getLSCache / setLSCache (localStorage stubbed)', () => {
  ...
  test('clearProjectRuntimeProviderCache removes both the native and gateway scoped entries', () => {
    setLSCache(LS_PROVIDERS, { all: ['native'] }, 'proj:p1:native');
    setLSCache(LS_PROVIDERS, { all: ['gateway'] }, 'proj:p1:gateway');
    clearProjectRuntimeProviderCache('p1');
