 ...
 */
/**
 * Message cache for useRuntimeMessages — prevents creating new array references
...
export function useRuntimeMessages(sessionId: string) {
...
export function useSendRuntimeMessage() {
  return useMutation({ mutationFn: promptRuntimeMessage });
}
