 ...
 * usable in a session iff it is global, or the session's subproject owns or
...
const roster: RosterAgent[] = [
  { name: 'kortix', subproject: null } as RosterAgent,
  { name: 'writer', subproject: 'marketing' } as RosterAgent,
  { name: 'researcher', subproject: 'research' } as RosterAgent,
...
describe('agentsUsableIn', () => {
  ...
  test('a subproject sees globals plus what it owns or references, in roster order', () => {
    expect(
