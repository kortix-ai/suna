...
export function createKortix(config: KortixPlatformConfig, opts?: { global?: boolean }) {
  ...
  const github = {
    ...
    createConnectSession: P.createGitHubConnectSession,
    createReconnectSession: P.createGitHubReconnectSession,
    refreshConnection: P.refreshGitHubConnection,
    disconnectConnection: P.disconnectGitHubConnection,
