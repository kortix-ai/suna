...
| `kortix.github` | Nango-backed account GitHub lifecycle: `createConnectSession` · `createReconnectSession` · `refreshConnection` · `disconnectConnection` · `listInstallations` · `listRepositories` · `listRepositoryBranches` · `linkRepository` |
