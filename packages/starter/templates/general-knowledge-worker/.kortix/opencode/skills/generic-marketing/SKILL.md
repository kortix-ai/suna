...
description: "Generic starter template — frameworks for planning campaigns, creating content, documenting and enforcing brand voice, and measuring marketing performance."
defaultProjectInstall: true
---

> **TODO — make this yours.** This is a generic starting template. Edit it to fit your own marketing operation: your channels and brand voice, your ICP and audience segments, your campaign cadence, and your reporting/analytics stack. Delete what you don't use.

# Marketing Skill

Frameworks and guidance for planning marketing campaigns, creating content across channels, keeping brand voice consistent, and measuring/optimizing performance.
...
#### 5. Measure
Define how you will know the campaign worked. See Success Metrics by Campaign Type below, and the Performance section for channel-level metrics.
...
1. **Brand Personality** — define the brand as if it were a person. What are its defining traits? Example: "If our brand were a person, they would be a knowledgeable colleague who explains complex things simply, celebrates your wins genuinely, and never talks down to you."
2. **Voice Attributes** — 3-5 attributes that define how the brand communicates (see below).
3. **Audience Awareness** — who the brand is speaking to (primary and secondary), what they care about, their expertise level, and how they expect to be addressed.
4. **Core Messaging Pillars** — 3-5 key themes the brand consistently communicates, their hierarchy, and how each connects to audience needs.
5. **Tone Spectrum** — how the voice adapts across contexts while remaining recognizably the same brand (see Tone Adaptation below).
6. **Style Rules** — specific grammar, formatting, and language rules (see Style Guide Enforcement below).
7. **Terminology** — preferred and avoided terms (see Terminology Management below).

### Voice Attributes

#### Common Voice Attribute Pairs
When defining brand voice, it helps to position attributes on a spectrum:
...
| Pages indexed | Number of pages in search index | Indexability and site health |
