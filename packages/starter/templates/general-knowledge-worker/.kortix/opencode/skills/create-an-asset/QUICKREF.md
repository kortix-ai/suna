...
> For web-based formats (landing pages), use the `website-building` family of skills for visual design and styling. This skill's design guidance applies to non-web outputs only.
