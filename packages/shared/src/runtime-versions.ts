...
export type RuntimeVersions = {
  ...
  opencodeSdk: string;
  codexCli: string;
  codexCliSha256Amd64: string;
  codexCliSha256Arm64: string;
  claudeCode: string;
  claudeCodeSha256Amd64: string;
  claudeCodeSha256Arm64: string;
  agentBrowser: string;
  playwright: string;
  anydoc: string;
};
...
export const CODEX_CLI_SHA256_AMD64 = RUNTIME_VERSIONS.codexCliSha256Amd64;
export const CODEX_CLI_SHA256_ARM64 = RUNTIME_VERSIONS.codexCliSha256Arm64;
export const CLAUDE_CODE_VERSION = RUNTIME_VERSIONS.claudeCode;
export const CLAUDE_CODE_SHA256_AMD64 = RUNTIME_VERSIONS.claudeCodeSha256Amd64;
export const CLAUDE_CODE_SHA256_ARM64 = RUNTIME_VERSIONS.claudeCodeSha256Arm64;
