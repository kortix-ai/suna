...
export const META_AGENT_GUIDE = [
  ...
  '   residue with exactly one of `kortix tasks progress` or `kortix tasks no-progress` with the same stable turn settlement id. Progress also cites its evidence ref. The coordinator then transitions its claim to `done`',
