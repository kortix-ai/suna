...
export {
  ...
  accountSsoProtocolEnum,
  accountSsoConnectionStatusEnum,
  accountVerifiedDomainStatusEnum,
  ...
  accountSsoConnectionsRelations,
  accountVerifiedDomainsRelations,
  auditEvents,
  usageEvents,
  // Kortix tables
  projects,
