// Migration: task_liveness_sweep_index  (NON-TRANSACTIONAL -- CONCURRENTLY escape hatch)
//
...
export const up = (pgm) => {
  ...
  pgm.sql(`
    create index concurrently if not exists idx_project_tasks_liveness_sweep
      on kortix.project_tasks (status, liveness_last_swept_at, task_id)
