-- Migration: task_git_write_requires_doing_worker
--
...
ALTER TABLE "kortix"."project_tasks" ADD CONSTRAINT "project_tasks_git_write_requires_doing_worker" CHECK ("kortix"."project_tasks"."git_write_request_id" is null or (
        "kortix"."project_tasks"."status" = 'doing'
        and "kortix"."project_tasks"."liveness_worker_session_id" is not null
        and "kortix"."project_tasks"."liveness_deadline_at" is not null
      )) NOT VALID;
