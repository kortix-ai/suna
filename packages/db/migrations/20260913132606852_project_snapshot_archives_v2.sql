-- Migration: project_snapshot_archives_v2
--
...
ALTER TABLE "kortix"."project_snapshot_archives" ADD COLUMN "format" varchar(32) DEFAULT 'project-snapshot-v1' NOT NULL;--> statement-breakpoint
ALTER TABLE "kortix"."project_snapshot_archives" ADD COLUMN "blobs_sha256" varchar(64);--> statement-breakpoint
ALTER TABLE "kortix"."project_snapshot_archives" ADD COLUMN "blobs_bytes" bigint;