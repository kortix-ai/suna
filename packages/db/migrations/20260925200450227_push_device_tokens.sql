...
CREATE TABLE "kortix"."push_device_tokens" (
	"token" text PRIMARY KEY NOT NULL,
	"user_id" uuid NOT NULL,
	"platform" text NOT NULL,
	"provider" text DEFAULT 'expo' NOT NULL,
	"enabled" boolean DEFAULT true NOT NULL,
	"on_completion" boolean DEFAULT true NOT NULL,
	"on_error" boolean DEFAULT true NOT NULL,
	"on_question" boolean DEFAULT true NOT NULL,
	"on_permission" boolean DEFAULT true NOT NULL,
	"play_sound" boolean DEFAULT true NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "push_device_tokens_platform" CHECK ("kortix"."push_device_tokens"."platform" in ('ios', 'android'))
);
--> statement-breakpoint
CREATE INDEX "idx_push_device_tokens_user" ON "kortix"."push_device_tokens" USING btree ("user_id");