// Migration: usage_event_idempotency_index  (NON-TRANSACTIONAL -- CONCURRENTLY escape hatch)
//
...
export const up = (pgm) => {
  ...
  pgm.sql(`
    create unique index concurrently if not exists idx_usage_events_account_idempotency
      on kortix.usage_events (account_id, idempotency_key)
