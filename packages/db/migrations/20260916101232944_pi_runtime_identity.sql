...
ALTER TABLE "kortix"."account_tokens" ADD COLUMN "runtime_kind" varchar(16);--> statement-breakpoint
ALTER TABLE "kortix"."account_tokens" ADD COLUMN "runtime_id" uuid;--> statement-breakpoint
ALTER TABLE "kortix"."session_environments" ADD COLUMN "environment_id" uuid;
