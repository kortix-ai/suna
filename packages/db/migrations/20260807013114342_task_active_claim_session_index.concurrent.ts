// Migration: task_active_claim_session_index  (NON-TRANSACTIONAL -- CONCURRENTLY escape hatch)
//
...
export const up = (pgm) => {
  ...
  pgm.sql(`
    create unique index concurrently if not exists idx_project_tasks_active_claim_session
