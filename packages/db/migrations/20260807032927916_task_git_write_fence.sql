-- Migration: task_git_write_fence
--
...
ALTER TABLE "kortix"."project_tasks" ADD COLUMN "git_write_request_id" text;--> statement-breakpoint
ALTER TABLE "kortix"."project_tasks" ADD COLUMN "git_write_lease_expires_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "kortix"."project_tasks" ADD CONSTRAINT "project_tasks_git_write_lease_pair" CHECK (num_nonnulls("kortix"."project_tasks"."git_write_request_id", "kortix"."project_tasks"."git_write_lease_expires_at") in (0, 2)) NOT VALID;--> statement-breakpoint
ALTER TABLE "kortix"."project_tasks" ADD CONSTRAINT "project_tasks_git_write_lease_within_worker_deadline" CHECK ("kortix"."project_tasks"."git_write_lease_expires_at" is null or "kortix"."project_tasks"."git_write_lease_expires_at" <= "kortix"."project_tasks"."liveness_deadline_at") NOT VALID;