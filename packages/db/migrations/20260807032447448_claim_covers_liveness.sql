-- Migration: claim_covers_liveness
--
...
ALTER TABLE "kortix"."project_tasks" ADD CONSTRAINT "project_tasks_claim_covers_liveness" CHECK ("kortix"."project_tasks"."liveness_deadline_at" is null or "kortix"."project_tasks"."claim_expires_at" >= "kortix"."project_tasks"."liveness_deadline_at") NOT VALID;