// Migration: account_model_preferences_scope_global_index  (NON-TRANSACTIONAL -- CONCURRENTLY escape hatch)
//
...
// pins) -- the OLD unconditional index is dropped only in a LATER migration
// (...drop_account_model_preferences_scope_index), once both replacement
// indexes already exist, so uniqueness is never unenforced in the gap.
