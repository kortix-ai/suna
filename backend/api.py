...
allowed_origins = [
    "https://www.sprintlab.id",
    "https://sprintlab.id",
    "https://dev.sprintlab.id",
    "https://staging.sprintlab.id",
    "https://prod-test.sprintlab.id",
]
# Allow all *.sprintlab.id subdomains and Vercel preview deployments
allow_origin_regex = r"https://([a-z0-9-]+\.)?sprintlab\.id|https://.*-sprintlab\.vercel\.app"
...
if config.ENV_MODE == EnvMode.STAGING:
    allowed_origins.append("https://staging.sprintlab.id")
    allowed_origins.append("http://localhost:3000")
