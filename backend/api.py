...
allowed_origins = ["https://www.adentic.so", "https://adentic.so"]
...
if config.ENV_MODE == EnvMode.STAGING:
    allowed_origins.append("https://staging.adentic.so")
    allowed_origins.append("http://localhost:3000")
    allow_origin_regex = r"https://adentic-.*-prjcts\.vercel\.app"
