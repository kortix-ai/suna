...
from core.middleware.utils import verify_and_get_user_id_from_jwt, require_agent_access, AuthorizedAgentAccess
...
async def delete_entry(
    ...
    try:
        ...
        try:
            from core.infrastructure.cache.runtime_cache import invalidate_kb_context_cache
...
async def update_agent_assignments(
    ...
    try:
        ...
        try:
            from core.infrastructure.cache.runtime_cache import invalidate_agent_config_cache, invalidate_kb_context_cache
