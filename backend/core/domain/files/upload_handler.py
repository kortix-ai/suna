...
from core.integrations.sandbox.sandbox import create_sandbox, delete_sandbox, get_or_start_sandbox
...
async def fast_parse_files(files: List[UploadFile], prompt: str = "") -> Tuple[str, List[Tuple[str, bytes, str, Optional[str]]]]:
    ...
    """
    from core.shared.async_parser import parse, FileType, format_file_size
...
async def upload_staged_files_to_sandbox_background(
    ...
    try:
        from core.domain.files import get_staged_file_content
