...
from core.domain.billing.subscriptions import free_tier_service
from core.domain.agents.suna_default_agent_service import SunaDefaultAgentService
from core.infrastructure.database.supabase import DBConnection
from core.infrastructure.email.client import email_service
    ...
    try:
        ...
        if user_record:
            ...
            if referral_code:
                ...
                try:
                    from core.domain.referrals.service import ReferralService
