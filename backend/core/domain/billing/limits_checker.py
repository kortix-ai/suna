...
async def check_agent_run_limit(client, account_id: str) -> Dict[str, Any]:
    try:
        ...
        from core.infrastructure.cache.runtime_cache import get_cached_running_runs, set_cached_running_runs
        ...
        async def get_tier_info():
            try:
                from core.infrastructure.cache.runtime_cache import get_cached_tier_info, set_cached_tier_info
...
async def check_project_count_limit(client, account_id: str) -> Dict[str, Any]:
    try:
        ...
        from core.domain.billing.shared.config import get_project_limit
...
async def check_thread_limit(client, account_id: str) -> Dict[str, Any]:
    try:
        ...
        from core.infrastructure.cache.runtime_cache import get_cached_thread_count, set_cached_thread_count
