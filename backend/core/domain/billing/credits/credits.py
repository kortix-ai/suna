...
from core.domain.billing.shared.config import FREE_TIER_INITIAL_CREDITS, TRIAL_ENABLED, get_tier_by_name
...
class CreditService:
    ...
    async def grant_tier_credits(self, user_id: str, price_id: str, tier_name: str) -> bool:
        try:
            from core.domain.billing.shared.config import get_tier_by_price_id
