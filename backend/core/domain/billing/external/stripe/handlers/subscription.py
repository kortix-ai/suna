...
from core.domain.billing.shared.config import get_tier_by_price_id, get_tier_by_name, get_plan_type, is_commitment_price_id
...
class SubscriptionHandler:
    ...
    async def _route_to_lifecycle_if_needed(self, event, subscription, client):
        if subscription.status in ['active', 'trialing', 'past_due']:
            ...
            from core.domain.billing.subscriptions import subscription_service
