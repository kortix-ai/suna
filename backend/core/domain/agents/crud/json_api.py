...
from core.middleware.utils import verify_and_get_user_id_from_jwt
from core.shared.logger import logger
from core.domain.agents.templates.service import MCPRequirementValue, ConfigType, ProfileId, QualifiedName

from core.shared.api_models.imports import JsonAnalysisRequest, JsonAnalysisResponse, JsonImportRequestModel, JsonImportResponse
...
class JsonImportService:
    ...
    async def _validate_requirements(
        ...
        from core.domain.agents.templates.installation_service import InstallationService
    ...
    async def _build_agent_config_from_json(
        ...
        from core.domain.credentials import get_profile_service
        ...
        for req in requirements:
            if req.custom_type == 'composio':
                ...
                if profile_id:
                    from core.integrations.composio.composio_profile_service import ComposioProfileService
    ...
    async def _create_initial_version(
        ...
        try:
            ...
            from core.domain.agents.versioning.version_service import VersionService
...
async def export_agent(agent_id: str, user_id: str = Depends(verify_and_get_user_id_from_jwt)):
    ...
    try:
        from core.domain.agents import repo as agents_repo
        from core.domain.agents.versioning import repo as versioning_repo
        ...
        from core.domain.agents.templates.service import TemplateService
...
async def import_agent_from_json(
    ...
    from core.domain.billing.limits_checker import check_agent_count_limit
