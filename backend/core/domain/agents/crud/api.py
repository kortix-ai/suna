...
from core.shared.pagination import PaginationParams
...
from core.shared.api_models import (
...
db = DBConnection()
from core.integrations.mcp.helpers import merge_custom_mcps
...
async def delete_agent(agent_id: str, user_id: str = Depends(verify_and_get_user_id_from_jwt)):
    ...
    try:
        ...
        try:
            from core.domain.triggers.trigger_service import get_trigger_service
...
async def get_agents(
    ...
    try:
        from ..service import AgentService, AgentFilters
...
async def generate_agent_icon(
    ...
    try:
        from core.shared.icon_generator import generate_icon_and_colors as generate_agent_icon_and_colors
