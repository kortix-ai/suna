...
from core.domain.agents.tools.utils.tool_discovery import get_tools_metadata
...
async def get_tool_details(
    ...
    try:
        ...
        from core.domain.agents.tools.utils.tool_discovery import get_tool_discovery
