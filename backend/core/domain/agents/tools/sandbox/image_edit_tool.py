...
from core.framework.tool import ToolResult, openapi_schema, tool_metadata
from core.integrations.sandbox.tool_base import SandboxToolsBase
...
from core.domain.billing.credits.media_integration import media_billing
from core.domain.billing.credits.media_calculator import select_image_quality, cap_quality_for_tier, FREE_TIERS
from core.shared.image_processing import upscale_image_sync, remove_background_sync, UPSCALE_MODEL, REMOVE_BG_MODEL
from core.domain.files.file_name_generator import generate_smart_filename
...
class SandboxImageEditTool(SandboxToolsBase):
    ...
    async def _get_user_tier(self, account_id: str) -> str:
        ...
        try:
            from core.domain.billing.subscriptions.handlers.tier import TierHandler
