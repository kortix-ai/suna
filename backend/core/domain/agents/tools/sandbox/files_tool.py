...
from core.domain.files.utils import should_exclude_file, clean_path
        ...
        try:
            ...
            if slide_match:
                ...
                try:
                    ...
                    from core.domain.agents.tools.sandbox.presentation_tool import SandboxPresentationTool
