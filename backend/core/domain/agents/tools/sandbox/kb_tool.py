...
from core.domain.knowledge_base.validation import FileNameValidator, ValidationError
...
"""
    ...
    async def global_kb_create_folder(self, name: str, description: str = None) -> ToolResult:
        ...
        try:
            ...
            from core.domain.knowledge_base.validation import validate_folder_name_unique
            client = await self.thread_manager.db.client
    ...
    async def global_kb_upload_file(self, sandbox_file_path: str, folder_name: str, description: str = None) -> ToolResult:
        ...
        try:
            ...
            from core.domain.knowledge_base.file_processor import FileProcessor
            import os
            import mimetypes
            ...
            from core.domain.knowledge_base.validation import validate_file_name_unique_in_folder
