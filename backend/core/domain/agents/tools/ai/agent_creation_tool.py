...
from core.framework.tool import Tool, ToolResult, openapi_schema, tool_metadata
if TYPE_CHECKING:
    from core.framework.thread_manager import ThreadManager
from core.shared.logger import logger
from core.domain.agents.tools.utils.core_tools_helper import ensure_core_tools_enabled
...
class AgentCreationTool(Tool):
    ...
    async def search_mcp_servers_for_agent(self, search_query: str) -> ToolResult:
        try:
            from core.integrations.composio.composio_service import get_integration_service
            from core.integrations.composio.toolkit_service import ToolkitService
    ...
    async def discover_mcp_tools_for_agent(self, profile_name: str) -> ToolResult:
        try:
            ...
            from core.integrations.mcp.service import mcp_service
    ...
    async def create_agent_scheduled_trigger(
        ...
        try:
            ...
            from core.domain.triggers import get_trigger_service
    ...
    async def list_agent_scheduled_triggers(self, agent_id: str) -> ToolResult:
        try:
            ...
            from core.domain.triggers import get_trigger_service, TriggerType
            trigger_svc = get_trigger_service(self.db)
