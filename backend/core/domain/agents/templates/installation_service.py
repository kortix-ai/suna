...
from .service import AgentTemplate, MCPRequirementValue, ConfigType, ProfileId, QualifiedName
from core.domain.triggers.api import sync_triggers_to_version_config
...
class InstallationService:
    ...
    async def _get_template(self, template_id: str) -> Optional[AgentTemplate]:
        from .service import get_template_service
