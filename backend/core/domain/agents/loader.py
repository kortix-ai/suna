...
class AgentData:
    ...
    def to_pydantic_model(self):
        ...
        from core.shared.api_models.agents import AgentResponse, AgentVersionResponse
...
class AgentLoader:
    ...
    async def load_agent(
        ...
        if load_config and not skip_cache:
            from core.infrastructure.cache.runtime_cache import get_cached_agent_config
        ...
        if load_config and agent_row.get('current_version_id'):
            ...
            # Cache the result
            from core.infrastructure.cache.runtime_cache import set_cached_agent_config
    ...
    async def _load_suna_config(self, agent: AgentData, user_id: Optional[str] = None):
        ...
        if agent.current_version_id and user_id:
            from core.infrastructure.cache.runtime_cache import get_cached_user_mcps, set_cached_user_mcps
