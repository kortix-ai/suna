...
class VersionService:
    ...
    async def _update_agent_current_version(self, agent_id: str, version_id: str, version_count: int):
        ...
        from core.infrastructure.cache.runtime_cache import invalidate_mcp_version_config
    ...
    async def create_version(
        ...
        try:
            from core.infrastructure.cache.runtime_cache import invalidate_agent_config_cache
    ...
    async def get_current_mcp_config(self, agent_id: str, user_id: str = "system") -> Optional[Dict[str, Any]]:
        ...
        from core.infrastructure.cache.runtime_cache import (
