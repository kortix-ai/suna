...
from typing import TYPE_CHECKING, Optional, Dict, List, Any, AsyncGenerator, TypeVar, Tuple
...
if TYPE_CHECKING:
    from core.framework.response_processor import ProcessorConfig
...
from core.domain.agents.tools.mcp_tool_wrapper import MCPToolWrapper
from core.domain.agents.tools.utils.tool_output_streaming import (
    set_tool_output_streaming_context,
    clear_tool_output_streaming_context,
    get_tool_output_streaming_context,
)

from core.domain.agents.runner.config import AgentConfig
from core.domain.agents.runner.tool_manager import ToolManager
from core.domain.agents.runner.mcp_manager import MCPManager
from core.domain.agents.runner.prompt_manager import PromptManager
...
async def ensure_project_metadata_cached(project_id: str) -> None:
    ...
    from core.infrastructure.cache.runtime_cache import get_cached_project_metadata, set_cached_project_metadata
...
async def send_completion_notification(thread_id: str, agent_config: Optional[Dict[str, Any]], complete_tool_called: bool):
    ...
    try:
        from core.domain.notifications.notification_service import notification_service
        from core.domain.threads import repo as threads_repo
...
class AgentRunner:
    ...
    async def setup(self):
        ...
        from core.integrations.mcp.jit.tool_cache import get_tool_cache
