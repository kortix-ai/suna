...
from core.domain.agents.tools.communication.message_tool import MessageTool
from core.domain.agents.tools.web.web_search_tool import SandboxWebSearchTool
from core.domain.agents.tools.web.image_search_tool import SandboxImageSearchTool
from core.domain.agents.tools.communication.expand_msg_tool import ExpandMessageTool
from core.domain.agents.tools.communication.task_list_tool import TaskListTool
...
class ToolManager:
    ...
    def _register_enabled_core_tools(self):
        ...
        from core.domain.agents.tools.registry import get_tool_info, get_tool_class
        ...
        if self._is_tool_enabled('browser_tool'):
            from core.domain.agents.tools.web.browser_tool import BrowserTool
    ...
    def _get_migrated_tools_config(self) -> dict:
        ...
        from core.domain.agents.tools.utils.tool_migration import migrate_legacy_tool_config
    ...
    def _get_enabled_methods_for_tool(self, tool_name: str) -> Optional[List[str]]:
        ...
        from core.domain.agents.tools.utils.tool_discovery import get_enabled_methods_for_tool
