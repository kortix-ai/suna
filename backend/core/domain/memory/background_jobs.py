...
async def run_memory_extraction(
    ...
    from core.shared.init_helpers import initialize
    ...
    try:
        from core.domain.memory.extraction_service import MemoryExtractionService
        from core.domain.billing import subscription_service
        from core.domain.billing.shared.config import is_memory_enabled
...
async def run_memory_embedding(
    ...
    try:
        from core.domain.memory.embedding_service import EmbeddingService
        from core.domain.billing import subscription_service
        from core.domain.billing.shared.config import get_memory_config
