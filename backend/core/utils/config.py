...
class Configuration:
    ...
    OR_SITE_URL: Optional[str] = "https://adentic.ai"
    OR_APP_NAME: Optional[str] = "TryAdentic"    
    ...
    SANDBOX_IMAGE_NAME = "adentic/adentic:0.1.3.20"
    SANDBOX_SNAPSHOT_NAME = "adentic/adentic:0.1.3.20"
    ...
    ADENTIC_ADMIN_API_KEY: Optional[str] = None
    ...
    def __init__(self):
        ...
        if not self.ADENTIC_ADMIN_API_KEY:
            self.ADENTIC_ADMIN_API_KEY = self._generate_admin_api_key()
            logger.info("Auto-generated ADENTIC_ADMIN_API_KEY for administrative functions")
