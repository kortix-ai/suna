...
class Configuration:
    ...
    MEMORY_EXTRACTION_MODEL: Optional[str] = "sprintlab/basic"
    ...
    OR_SITE_URL: Optional[str] = "https://www.sprintlab.id"
    OR_APP_NAME: Optional[str] = "SprintLab.id"
    ...
    SPRINTLAB_ADMIN_API_KEY: Optional[str] = None
    ...
    def FRONTEND_URL(self) -> str:
        ...
        Returns:
        - Production: 'https://sprintlab.id' (or FRONTEND_URL_ENV if set)
        - Staging: 'https://staging.sprintlab.id' (or FRONTEND_URL_ENV if set)
    ...
    def _generate_admin_api_key(self) -> str:
        """Generate a secure admin API key for SprintLab administrative functions."""
    ...
    def __init__(self):
        ...
        if not self.SPRINTLAB_ADMIN_API_KEY:
            self.SPRINTLAB_ADMIN_API_KEY = self._generate_admin_api_key()
            logger.info("Auto-generated SPRINTLAB_ADMIN_API_KEY for administrative functions")
