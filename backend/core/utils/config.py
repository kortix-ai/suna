...
class Configuration:
    ...
    STRIPE_TIER_2_20_ID_PROD: str = 'price_1S5xmDRGnNhiCslu7gLvpQCt'
    ...
    STRIPE_TIER_2_20_ID_STAGING: str = 'price_1S5xmDRGnNhiCslu7gLvpQCt'
    ...
    # Stripe Product IDs
    STRIPE_PRODUCT_ID_PROD: str = 'prod_SZqErtOBuura60'
