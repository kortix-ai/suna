...
from core.integrations.sandbox.sandbox import get_or_start_sandbox, delete_sandbox, create_sandbox, daytona
from core.shared.logger import logger
from core.middleware.utils import get_optional_user_id, verify_and_get_user_id_from_jwt, verify_sandbox_access, verify_sandbox_access_optional
from core.infrastructure.database.supabase import DBConnection
from core.integrations.sandbox.utils import generate_unique_filename, get_uploads_directory
...
async def get_sandbox_by_id_safely(client, sandbox_id: str) -> AsyncSandbox:
    ...
    """
    from core.domain.resources import ResourceService, ResourceType
...
async def create_file_in_project(
    ...
    try:
        ...
        from core.domain.files import ensure_sandbox_for_thread
...
async def websocket_pty_terminal(
    ...
    try:
        ...
        from core.middleware.utils import _decode_jwt_with_verification
        try:
