...
from core.middleware.utils import verify_and_get_user_id_from_jwt, get_optional_current_user_id_from_jwt
...
from core.domain.triggers.trigger_service import get_trigger_service, TriggerEvent, TriggerType
from core.domain.triggers.execution_service import get_execution_service
...
async def create_composio_trigger(req: CreateComposioTriggerRequest, current_user_id: str = Depends(verify_and_get_user_id_from_jwt)) -> Dict[str, Any]:
    try:
        ...
        if config.ENV_MODE != EnvMode.LOCAL:
            from core.domain.billing.limits_checker import check_trigger_limit
