...
class ProductMapper:
    PRODUCT_MAPPING = {
        'sprintlab_plus_monthly': 'tier_2_20',
        'sprintlab_plus_yearly': 'tier_2_20',
        'plus:plus-monthly' : 'tier_2_20',
        'plus:plus-monthly' : 'tier_2_20',

        'sprintlab_pro_monthly': 'tier_6_50',
        'sprintlab_pro_yearly': 'tier_6_50',
        'pro:pro-monthly' : 'tier_6_50',
        'pro:pro-monthly' : 'tier_6_50',

        'sprintlab_ultra_monthly': 'tier_25_200',
        'sprintlab_ultra_yearly': 'tier_25_200',
