...
class EmailService:
    def __init__(self):
        ...
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', ' Team')
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix--logo.png" alt="Kortix Logo" class="logo">
    </div>
    <h1>Welcome to Kortix!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Kortix — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the  community <span class="emoji">🌞</span></p>

    <p>— The  Team</p>

    <a href="https://www..kortix.com/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Go to the platform: https://www.kortix.com/

---
© 2025 . All rights reserved.
You received this email because you signed up for a  account."""
