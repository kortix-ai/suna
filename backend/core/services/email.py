...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'hello@adentic.com')
...
<head>
  ...
  <title>Welcome to Adentic</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://adentic.com/logo.png" alt="Adentic Logo" class="logo">
    </div>
    <h1>Welcome to Adentic!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Adentic — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the Adentic community!</p>

    <p>— The Adentic Team</p>

    <a href="https://www.adentic.com/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Go to the platform: https://www.adentic.com/

---
© 2025 Adentic. All rights reserved.
You received this email because you signed up for an Adentic account."""
