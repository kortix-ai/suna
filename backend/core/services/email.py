...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'dom@adentic.ai')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Adentic Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Adentic — Let's Get Started "
...
<head>
  ...
  <title>Welcome to TryAdentic</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/adentic-adentic-logo.png" alt="TryAdentic Logo" class="logo">
    </div>
    <h1>Welcome to TryAdentic!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to TryAdentic — we're excited to have you on board!</strong></em></p>
    ...
    <p><strong>For your business:</strong> if you want to automate manual and ordinary tasks for your company, book a call with us <a href="https://cal.com/team/adentic/enterprise-demo">here</a></p>

    <p>Thanks again, and welcome to the Adentic community <span class="emoji">🌞</span></p>

    <p>— The Adentic Team</p>

    <a href="https://www.adentic.so/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Adentic — we're excited to have you on board!
...
For your business: if you want to automate manual and ordinary tasks for your company, book a call with us here: https://cal.com/team/adentic/enterprise-demo 

Thanks again, and welcome to the Adentic community 🌞

— The Adentic Team

Go to the platform: https://www.adentic.so/

---
© 2025 Adentic. All rights reserved.
You received this email because you signed up for a Adentic account."""
