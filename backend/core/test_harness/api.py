...
async def start_benchmark_test(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Failed to start test. Please try again later."
        )
...
async def get_test_run(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Failed to retrieve test run. Please try again later."
        )
...
async def list_test_runs(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Failed to list test runs. Please try again later."
        )
...
async def cancel_test_run(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Failed to cancel test run. Please try again later."
        )
...
async def run_e2e_tests(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Failed to run E2E tests. Please try again later."
        )
