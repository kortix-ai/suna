...
from core.framework.prompt_caching import apply_anthropic_caching_strategy
    ...
    async def count_tokens(self, model: str, messages: List[Dict[str, Any]], system_prompt: Optional[Dict[str, Any]] = None, apply_caching: bool = True) -> int:
        ...
        # Check if this is a Bedrock model
            ...
            try:
                ...
                if bedrock_client:
                    # Import profile IDs
                    from core.config.registry import KIMI_K2_PROFILE_ID, SONNET_4_5_PROFILE_ID, HAIKU_4_5_PROFILE_ID, MINIMAX_M2_PROFILE_ID
                    ...
                    if not bedrock_model_id:
                        ...
                        from core.config.registry import KIMI_K2_PROFILE_ID
