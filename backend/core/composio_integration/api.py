...
async def list_categories(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to fetch categories. Please try again later.")
...
async def list_toolkits(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to fetch toolkits. Please try again later.")
...
async def get_toolkit_details(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to fetch toolkit details. Please try again later.")
...
async def get_profile_mcp_config(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get MCP config. Please try again later.")
...
async def get_profile_info(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get profile info. Please try again later.")
...
async def list_toolkit_tools(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get toolkit tools. Please try again later.")
