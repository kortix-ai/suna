...
async def regenerate_signed_link(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to regenerate link. Please try again later.")
...
async def get_file_upload(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get file upload. Please try again later.")
