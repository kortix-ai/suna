...
async def approve_apify_request(
    ...
    try:
        ...
        try:
            ...
            if max_cost_usd > 0:
                try:
                    ...
                    raise HTTPException(
                        status_code=500,
                        detail="Failed to process approval. Please try again later."
                    )
        ...
        raise HTTPException(status_code=500, detail="Failed to approve request. Please try again later.")
...
async def get_apify_approval_status(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get approval status. Please try again later.")
