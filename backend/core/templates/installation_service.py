...
class InstallationService:
    ...
    async def _create_agent(
        ...
        if template.is_adentic_team:
            metadata['is_adentic_team'] = True
            metadata['adentic_template_id'] = template.template_id
        ...
        logger.debug(f"Created agent {agent_id} from template {template.template_id}, is_adentic_team: {template.is_adentic_team}")
        return agent_id
