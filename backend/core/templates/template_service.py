...
class TemplateService:
    ...
    async def create_from_agent(
        ...
        if self._is_adentic_default_agent(agent):
    ...
    async def get_public_templates(
        self,
        is_adentic_team: Optional[bool] = None,
        ...
        if is_adentic_team is not None:
            query = query.eq('is_adentic_team', is_adentic_team)
    ...
    def _is_adentic_default_agent(self, agent: Dict[str, Any]) -> bool:
        metadata = agent.get('metadata', {})
        return metadata.get('is_adentic_default', False)
    ...
    def _map_to_template(self, data: Dict[str, Any]) -> AgentTemplate:
        ...
        return AgentTemplate(
            ...
            is_adentic_team=data.get('is_adentic_team', False),
