...
@router.post("/adentic-agents/install-user/{account_id}")
async def admin_install_adentic_for_user(
    account_id: str,
    ...
    agent_id = await service.install_adentic_agent_for_user(account_id, replace_existing)
