...
def check_imports():
    ...
    imports = [
        ...
        "from core.domain.agents.api import router",
        "from core.domain.threads.api import router",
        "from core.domain.memory.background_jobs import start_memory_extraction",
        "from core.domain.agents.api import _load_agent_config",
        "from core.domain.agents.loader import get_agent_loader",
        "from core.domain.agents.api import start_agent_run",
    ]
...
def check_old_imports():
    ...
    old_patterns = [
        ("core.runtime_cache", "core.infrastructure.cache.runtime_cache"),
