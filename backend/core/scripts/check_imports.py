...
def main():
    ...
    test_cases = [
        ("core.services.supabase", "from core.infrastructure.database.supabase import DBConnection"),
        ("core.agents.api", "from core.domain.agents.api import router"),
        ("core.threads.api", "from core.domain.threads.api import router"),
        ("core.memory.background_jobs", "from core.domain.memory.background_jobs import start_memory_extraction"),
    ]
