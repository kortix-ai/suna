...
async def list_memories(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to fetch memories. Please try again later.")
...
async def get_memory_stats(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to fetch memory stats. Please try again later.")
...
async def delete_all_memories(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to delete all memories. Please try again later.")
...
async def create_memory(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to create memory. Please try again later.")
...
async def get_memory_settings(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get memory settings. Please try again later.")
...
async def update_memory_settings(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to update memory settings. Please try again later.")
...
async def get_thread_memory_settings(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get thread memory settings. Please try again later.")
...
async def update_thread_memory_settings(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to update thread memory settings. Please try again later.")
