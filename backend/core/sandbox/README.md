...
2. Build a custom image:
   ...
   docker push adentic/adentic:0.1.3.20
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `adentic/adentic:___`)
...
3. Push the new version: `docker push adentic/adentic:0.1.3`
