...
async def get_sandbox_by_id_safely(client, sandbox_id: str) -> AsyncSandbox:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to retrieve sandbox")
    ...
    try:
        ...
        if not paths:
            ...
            try:
                ...
                raise HTTPException(
                    status_code=400, detail="Snapshot revert failed"
                )
        ...
        try:
            ...
            raise HTTPException(
                status_code=400, detail="Snapshot file revert failed"
            )
