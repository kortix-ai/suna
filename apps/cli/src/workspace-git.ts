...
// `kortix workspaces clone`, `kortix git-credential`).
//
...
/** Minimal shape the resolver needs — `WorkspaceSummary` and the provision
...
/** A Kortix git-proxy origin (`https://<host>/v1/git/<workspaceId>.git`). The
