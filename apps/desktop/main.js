...
const PROTOCOL_SCHEME = 'xera';

// Get URL from environment variable or default to production
const APP_URL = process.env.APP_URL || 'https://xera.cc/';
...
// Register as default protocol handler for xera://
...
function handleDeepLink(url) {
  ...
  // Convert xera://auth/callback?code=xxx to https://xera.cc/auth/callback?code=xxx
...
function createWindow() {
  ...
  webContents.setUserAgent(webContents.getUserAgent() + ' Electron/Xera-Desktop');
