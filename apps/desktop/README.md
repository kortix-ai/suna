...
Minimal Electron wrapper for the Xera web application with deep linking support.

## Features

- Native macOS/Windows/Linux desktop app
- Deep linking for magic link authentication (`xera://` protocol)
...
By default, it loads `https://xera.cc/`.
...
The app registers the `xera://` protocol for magic link authentication:

1. User enters email in desktop app
2. Magic link email contains `xera://auth/callback?code=xxx`
3. User clicks link in email
4. Operating system opens Xera Desktop app
