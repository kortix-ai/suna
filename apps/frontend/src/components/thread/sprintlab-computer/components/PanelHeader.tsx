...
import { ViewType } from '@/stores/sprintlab-computer-store';
    ...
    return (
      <div className="h-14 flex-shrink-0 px-4 flex items-center justify-between border-b border-border">
        <div className="flex items-center">
          <Image
            src="/sprintlab-computer-white.svg"
            alt="SprintLab Computer"
            width={140}
            height={16}
          ...
          />
          <Image
            src="/sprintlab-computer-black.svg"
            alt="SprintLab Computer"
            width={140}
            height={16}
            ...
            priority
          />
          <DrawerTitle className="sr-only">SprintLab Computer</DrawerTitle>
        </div>
