...
import { SprintLabComputerHeader } from './SprintLabComputerHeader';
...
interface FileBrowserViewProps {
  ...
  projectId?: string;
  /** 
   * 'default' - Side panel view in SprintLab Computer (shows all files)
      ...
      <div className="flex flex-col min-h-screen bg-background">
        ...
        <Dialog open={revertModalOpen} onOpenChange={setRevertModalOpen}>
          <DialogContent className="sm:max-w-md rounded-xl bg-background border border-border">
            ...
            {revertLoadingInfo ? (
              <div className="py-6 flex items-center justify-center"><SprintLabLoader size="medium" /></div>
            ) : revertCommitInfo ? (
              <div className="mt-2">
            ...
            <DialogFooter>
              ...
              <Button onClick={performRevert} disabled={revertInProgress}>
                {revertInProgress ? (<><SprintLabLoader size="small" className="mr-2" />Restoring...</>) : 'Restore'}
              </Button>
            </DialogFooter>
            <DialogClose />
          </DialogContent>
