          ...
          <div className="relative w-full px-6">
            <div className="max-w-6xl mx-auto border-l border-r border-border">
              ...
              <div className="border-t border-border">
                <FAQItem
                  question="What is SprintLab?"
                  answer="SprintLab is a generalist AI worker that can perform real-world tasks on your behalf. Unlike traditional AI assistants, SprintLab can actually take action across your apps, automate workflows, and handle complex multi-step tasks autonomously."
                />
                <FAQItem
                  question="How can SprintLab help me?"
                  answer="SprintLab can automate repetitive tasks, manage your workflows, interact with web services, process data, create content, and coordinate complex operations across multiple platforms. Simply tell SprintLab what you need done, and it handles the execution from start to finish."
                />
                <FAQItem
                  question="How is SprintLab different from other AI platforms?"
                  answer="While most AI platforms only provide information or suggestions, SprintLab actually performs real-world tasks. It can browse the web, interact with APIs, manage files, execute commands, and integrate with your existing tools to complete tasks autonomously—not just tell you how to do them."
                />
                <FAQItem
                  question="Can SprintLab connect to my apps?"
                  answer="Yes! SprintLab can connect to thousands of apps and services through integrations. It can interact with your tools, APIs, databases, and workflows to automate tasks across your entire tech stack. You control which apps and services SprintLab can access."
                />
                <FAQItem
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 border-t border-border">
                <div className="p-8 border-r border-border space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-4">
                      Our terms and conditions for using SprintLab services, including user responsibilities and service limitations.
                    </p>
                ...
                <div className="p-8 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-4">
                      Company information and legal details about SprintLab AI Corp, including contact information and registration.
                    </p>
