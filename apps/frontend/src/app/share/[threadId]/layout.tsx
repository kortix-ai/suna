...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | SprintLab',
    description: 'Replay this Worker conversation on SprintLab',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | SprintLab';
    const description =
      projectData.description ||
      'Replay this Worker conversation on SprintLab';
