...
const slides: Slide[] = [
  ...
  },
  {
    ...
    subtitle: 'CEO & COO at SprintLab',
  },
  {
    id: 3,
    type: 'title',
    title: 'Demo',
    subtitle: 'Let\'s see SprintLab in action',
  },
...
// SprintLab Stack Diagram
const SprintLabStackDiagram = () => {
  const layers = [
      ...
      {slide.type === 'diagram' && (
        <div className="w-full max-w-4xl">
          ...
          >
            ...
            {slide.diagram === 'kortix-stack' && <SprintLabStackDiagram />}
