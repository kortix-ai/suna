                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <div className="text-muted-foreground mb-6 space-y-2">
                        <p>
                          <strong>SprintLab AI Corp</strong>
                        </p>
                      ...
                      <p className="text-muted-foreground mb-6">
                        SprintLab AI Corp is responsible for the content of this
...
CAREFULLY BEFORE USING THE SERVICES OFFERED BY SprintLab AI
                        ...
                        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE SprintLab
...
<li>
                          "Company" refers to SprintLab AI Corp, a Delaware corporation
                          with its principal place of business at 701 Tillery Street
                          Unit 12-2521, Austin, Texas 78702, United States.
                        </li>
                        <li>
                          "Site" refers to the SprintLab website, including any related
                          features, content, or applications offered from time to
                          time by the Company.
                        </li>
                        <li>
"Service" refers to the SprintLab platform and all related
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All SprintLab logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE SprintLab WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        SprintLab DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at SprintLab in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        SprintLab does not collect biometric or identifying
