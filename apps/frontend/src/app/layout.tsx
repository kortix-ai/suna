...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'SprintLab Team', url: 'https://www.kortix.com' }],
  creator: 'SprintLab Team',
  publisher: 'SprintLab Team',
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${roobert.variable} ${roobertMono.variable}`}>
      <head>
        ...
        <title>SprintLab: Your Autonomous AI Worker</title>
        ...
        <meta name="keywords" content="SprintLab, AI Worker, Agentic AI, Autonomous AI Worker, AI Automation, AI Workflow Automation, AI Assistant, Task Automation" />
        <meta property="og:title" content="SprintLab: Your Autonomous AI Worker" />
        ...
        <meta name="twitter:title" content="SprintLab: Your Autonomous AI Worker" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: ['SprintLab', 'SprintLab AI', 'SprintLab: Your Autonomous AI Worker'],
              url: siteMetadata.url,
              logo: `${siteMetadata.url}/favicon.png`,
              description: siteMetadata.description,
              foundingDate: '2024',
              sameAs: [
                'https://github.com/SprintLab-ai/Suna',
                'https://x.com/kortix',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [siteMetadata.name, 'SprintLab'],
