...
export const pricingTiers: PricingTier[] = [
  {
    ...
    features: [
      ...
      '1 concurrent run',
      '10 Total Chats',
      'Basic Mode - Core SprintLab experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create SprintLab Workers with custom Knowledge, Tools & Integrations',
      ...
      'SprintLab Advanced mode - Strongest autonomy & decision-making capabilities',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create SprintLab Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create SprintLab Workers with custom Knowledge, Tools & Integrations',
