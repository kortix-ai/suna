...
describe('Apps public edge', () => {
  ...
  // names the problem.
  //
  // An enterprise workspace, 2026-09-08: its E2B stack was hibernated (ASGs to
  // 0, its DNS pointing at a deleted load balancer) while all four live App
  // deployments were still pinned to e2b and ALLOWED_SANDBOX_PROVIDERS had been
  // narrowed to platinum. Every App rendered "Starting … This page will
  // continue automatically" and refreshed every 3 s, forever.
