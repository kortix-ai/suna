 ...
 * workspace-scoped (`account_tokens.project_id`); the IAM v2 engine
...
export interface AgentSpec {
  ...
  kortixCli: GrantSet;
  /** Workspace-secret IDENTIFIERS (project_secrets.identifier, not raw env-var
  ...
  sandbox?: string | null;
  /** Workspace file delivery mode for sessions started with this agent. */
 ...
 *     `opts.workspaceDefaultAgent` (the DB `project.metadata.default_agent`
