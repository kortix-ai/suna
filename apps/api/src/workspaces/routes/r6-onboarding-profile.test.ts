/**
 * `PATCH /v1/projects/:workspaceId/onboarding` — the `profile` envelope.
 *
 ...
 *
 * This file drives the REAL `r6.ts` Hono handler (`workspaceRoutesApp.request(...)`)
...
// import `./r1` (the file that runs `workspaceRoutesApp.use('/*', supabaseAuth)`):
...
function patch(body: Record<string, unknown>) {
  return workspaceRoutesApp.request(`/${WORKSPACE_ID}/onboarding`, {
    method: 'PATCH',
