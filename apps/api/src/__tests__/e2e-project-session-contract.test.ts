...
// Bounded-sandbox-lifetime columns. Every session_sandboxes fixture below is a
// full $inferSelect row, so both are required; the values are inert here (this
// suite exercises the session contract, not the deadline model).
const SANDBOX_ACTIVE_SINCE = new Date('2026-01-01T00:00:00Z');
const SANDBOX_DEADLINE_AT = new Date('2026-01-01T04:00:00Z');
    ...
    sessionSandboxRows = [
      {
        ...
        metadata: {},
        lastUsedAt: null,
        activeSince: SANDBOX_ACTIVE_SINCE,
        deadlineAt: SANDBOX_DEADLINE_AT,
        createdAt: new Date('2026-01-01T00:00:00Z'),
        updatedAt: new Date('2026-01-01T00:00:00Z'),
      },
    ];
