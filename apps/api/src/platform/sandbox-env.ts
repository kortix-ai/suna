 ...
 * are the session-scoped `KORTIX_TOKEN` and the environment's purpose-bound
 * `KORTIX_ENV_RPC_SECRET`.
 *
 ...
 * session token and environment RPC secret. Everything else matching a secret
 * shape is stripped.
 */
