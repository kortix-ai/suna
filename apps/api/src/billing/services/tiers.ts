...
const TIERS: Record<string, TierConfig> = {
  ...
  // unlimited runs + compute add-ons. Introduced Apr 2026 for pre-launch
  // volume stress test. Keep hidden:false so it appears in the pricing page.
  starter: {
    name: 'starter',
    displayName: 'Starter',
    monthlyPrice: 0,
...
const STRIPE_PRICES_PROD: StripePriceConfig = {
  subscriptions: {
    ...
    // Stripe subscription created via setup_intent or direct $0 sub.
