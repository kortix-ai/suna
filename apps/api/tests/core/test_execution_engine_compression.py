...
# Convex test fixtures - uses mock-based approach for unit tests
os.environ.setdefault("CONVEX_URL", "http://localhost:3210")
os.environ.setdefault("CONVEX_API_KEY", "test_api_key_for_unit_tests")
...
class TestContextExceeds200k:
    ...
    async def test_over_200k_generates_summary_and_compresses(self):
        ...
        with patch("core.ai_models.model_manager.get_context_window", return_value=200_000), \
             patch("core.services.convex.DBConnection", return_value=mock_db_conn), \
