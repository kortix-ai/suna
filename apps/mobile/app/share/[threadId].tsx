...
export default function ShareThreadPage() {
  ...
  // SprintLab Computer for viewing tool calls
  const { isOpen: isSprintLabComputerOpen, openPanel } = useSprintLabComputerStore();
  const [selectedToolData, setSelectedToolData] = React.useState<{
    toolMessages: ToolMessagePair[];
    initialIndex: number;
  } | null>(null);

  // Handle tool press - open SprintLab Computer
