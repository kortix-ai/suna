...
interface SprintLabComputerHeaderProps {
...
/**
 * Shared header component for all SprintLab Computer views (Files, File Viewer, Browser).
 ...
 */
export function SprintLabComputerHeader({
  icon: IconComponent,
  onIconClick,
  iconTitle,
  title,
