...
import { Clock, DollarSign, User, Bot } from 'lucide-react-native';
...
export function CallStatusToolView({ toolCall, toolResult, isStreaming = false, assistantTimestamp, toolTimestamp }: ToolViewProps) {
