...
export function ProjectScreenLegacy() {
  ...
  const goToProjects = useCallback(() => {
    haptics.tap();
    setDrawerOpen(false);
    // The list is where we came from, so unwind to it rather than stacking a
    // second copy on top. `dismissTo` replaces if it isn't in the stack.
