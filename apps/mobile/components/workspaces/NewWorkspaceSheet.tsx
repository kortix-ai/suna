/**
 * NewWorkspaceSheet — create a Workspace through the canonical Workspace API.
 *
...
// The physical database column remains projects.name. The public limit is Workspace-named.
