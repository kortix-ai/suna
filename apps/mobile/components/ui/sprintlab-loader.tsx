...
interface SprintLabLoaderProps {
  /**
...
/**
 * SprintLabLoader - A unified loading animation component
 *
 ...
 * <SprintLabLoader forceTheme="dark" />
 *
 * // With ref for manual control
 * const lottieRef = useRef<LottieView>(null);
 * <SprintLabLoader lottieRef={lottieRef} autoPlay={false} />
 * ```
 */
export function SprintLabLoader({
  size = 'medium',
  speed = 1.2,
  customSize,
  className,
