...
export const useSprintLabComputerStore = create<SprintLabComputerState>((set, get) => ({
  ...initialState,
...
export const useSprintLabComputerIsOpen = () =>
  useSprintLabComputerStore((state) => state.isOpen);
...
export const useSprintLabComputerSelectedVersion = () =>
  useSprintLabComputerStore((state) => state.selectedVersion);

export const useSprintLabComputerSelectedVersionDate = () =>
  useSprintLabComputerStore((state) => state.selectedVersionDate);

export const useSprintLabComputerVersionActions = () =>
