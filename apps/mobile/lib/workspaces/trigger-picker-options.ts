...
import type { WorkspaceAgentEntry, WorkspaceLlmCatalogResponse } from './workspaces-client';
...
export function filterTriggerAgents(agents: WorkspaceAgentEntry[] | undefined): TriggerAgentOption[] {
  return (agents ?? [])
...
export function flattenTriggerModelCatalog(
  models: WorkspaceLlmCatalogResponse['models'] | undefined,
): TriggerModelOption[] {
