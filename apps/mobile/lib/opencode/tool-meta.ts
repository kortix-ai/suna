 ...
 * and the web version at apps/web/src/components/session/tool-meta.ts.
 *
 * Only two concerns:
 ...
 *
 * NOTE: On mobile, `part.input` is at the top level of `ToolPart`, not
 * nested under `state.input` like on web.
 */
