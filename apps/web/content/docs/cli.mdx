...
| Command                           | Effect                                                           |
| --------------------------------- | ---------------------------------------------------------------- |
| `kortix templates list`           | Browse the catalog. `--query` filters. Aliases: `ls`, `search`.  |
| `kortix templates show <slug>`    | One template: what it declares and what it needs. Alias: `view`. |
| `kortix templates install <slug>` | Start the agent session that installs it.                        |
...
Templates is a per-project [feature flag](/docs/feature-flags), off by
