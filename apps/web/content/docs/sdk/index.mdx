...
<Cards>
  ...
  <Card title="Sessions" href="/docs/sdk/sessions">
    The session handle: lifecycle, runtime health, previews, and ACP agent transport.
  </Card>
  <Card title="Streaming" href="/docs/sdk/streaming">
    Live events, the readiness handshake, and the runtime support matrix.
  </Card>
  <Card title="ACP" href="/docs/sdk/acp">
    The ACP layer underneath the facade — AcpClient, the AcpSession store, and transcript projections.
  </Card>
  ...
  <Card title="Modules" href="/docs/sdk/modules">
    The functional areas — files, session runtime, runtime client, auth, turns — all on the
    root entry.
  </Card>
