...
<Cards>
  ...
  <Card title="Sessions" href="/docs/sdk/sessions">The session handle: lifecycle, runtime health, previews, and the typed opencode runtime.</Card>
  <Card title="React hooks" href="/docs/sdk/react">`@kortix/sdk/react` — reactive data: live messages, events, config, PTY.</Card>
  <Card title="Modules" href="/docs/sdk/modules">Subpath modules — files, session runtime, the opencode client, auth, stores.</Card>
</Cards>
