...
Pi sessions use their compiled agent and model. They do not inject the stored
...
Pi sessions return `409 SESSION_MODEL_FIXED_AT_START` without changing metadata.
Start a new Pi session to select another model.
