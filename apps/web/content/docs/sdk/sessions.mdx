...
This API stores assets. It does not submit them to Pi. Pi composer attachments
and image replay remain gated while that runtime integration is implemented.
