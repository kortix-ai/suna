...
[client](/docs/sdk/the-client) and needs no provider.
...
- [Sessions](/docs/sdk/sessions) — the session handle `useSession` wraps.
- [The client](/docs/sdk/the-client) — the full REST surface these hooks read from.
- [Error handling](/docs/sdk/error-handling) — the `KortixSendError` kinds.
