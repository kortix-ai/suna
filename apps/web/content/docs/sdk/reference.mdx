...
kortix.templates; // the public template catalog — list, get
...
#### `p.templates` — install a template

Behind the `templates` [feature flag](/docs/feature-flags/templates): the
call answers `403` `feature_disabled` while it is off. See
[Templates](/docs/sdk/templates).
