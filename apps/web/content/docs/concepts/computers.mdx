...
[session](/docs/concepts/sessions). A computer is a machine you already own,
and it stays connected across sessions.
...
[connector](/docs/concepts/connectors) that fronts every machine you connect.
