...
- **Editor** — everything a member can do, plus edit/customize the project and manage triggers.
...
access to every project (full control, including managing members and deleting
the project); a plain account **member** sees only the projects they're
granted a project role on.
