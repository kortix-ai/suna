...
Kortix runs each [session](/docs/concepts/sessions) on a model. This page
...
experimental setting, and it is on by default for cloud projects.
...
provider's env var directly as a [secret](/docs/concepts/secrets).
...
2. The [agent's](/docs/concepts/agents) default for this project.
...
[manifest reference](/docs/reference/manifest) for the trigger `model:`
field.
...
[secrets](/docs/concepts/secrets) page instead.
