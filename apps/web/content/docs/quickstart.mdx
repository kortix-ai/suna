...
your account and a default [project](/docs/concepts/projects) for you.
</Step>

<Step>
### Create or clone a project

To start a new project, run `kortix init` with a name. This scaffolds a
...
This starts a [session](/docs/concepts/sessions). The agent works in its own
...
<Cards>
  <Card title="How the pieces fit" href="/docs/concepts">
    Projects, sessions, and change requests, explained.
  </Card>
  <Card title="CLI command reference" href="/docs/reference/cli">
    Every command, flag, and subcommand.
  </Card>
  <Card title="The CLI dev loop" href="/docs/guides/developing">
