...
Open **Customize → Models → Providers**. Turn off **Kortix Managed Models** to use only your own providers. Each provider also has an **Enabled** switch beside its credentials.
