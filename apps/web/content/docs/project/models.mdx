...
Provider model-count links open the **Models** tab filtered to that provider. This is the same list used to enable or disable models and set defaults. Choose **All providers** to clear the filter. Connect a provider before managing its models.
