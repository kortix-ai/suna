...
<Cards>
  ...
  <Card icon={<PackageIcon />} title="Subprojects" href="/docs/feature-flags/subprojects">Install a whole Kortix project — agents, skills, connectors, triggers — into another project.</Card>
  <Card icon={<FlagIcon />} title="Feature flags" href="/docs/feature-flags">Per-project opt-ins, including Apps and Subprojects.</Card>
