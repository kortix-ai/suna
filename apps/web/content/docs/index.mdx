...
<Cards>
  ...
  <Card icon={<PackageIcon />} title="Crafts" href="/docs/feature-flags/crafts">Install a whole Kortix project — agents, skills, connectors, triggers — into another project.</Card>
  <Card icon={<FlagIcon />} title="Feature flags" href="/docs/feature-flags">Per-project opt-ins, including Apps and Crafts.</Card>
