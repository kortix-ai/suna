...
Kortix has two token vocabularies: external tokens you create yourself, and env vars Kortix injects inside a sandbox. This section covers both, and every other page links here for the full list.
