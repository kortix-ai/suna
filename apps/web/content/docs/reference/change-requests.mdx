...
These are separate capabilities, so a token can open CRs without the power to merge them. This is the mechanism behind [the agent mandate](#the-agent-mandate).
