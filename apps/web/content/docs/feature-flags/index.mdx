...
<CardGroup>
  <Card icon="app-window" title="Apps" href="/docs/feature-flags/apps">
    Deploy static sites, bundles, Dockerfiles, and OCI images to stable URLs.
  </Card>
  <Card icon="store" title="Marketplace" href="/docs/feature-flags/marketplace">
    Install a template — agents, skills, connectors and triggers — into a project by change request.
  </Card>
</CardGroup>
...
| ------------------------- | ----------------------- | ------------ | ----------------------------- | ------------ |
| `marketplace`             | Marketplace             | Experimental | Off                           | `routes`     |
...
- **`marketplace`** — browse the template catalog and install a template into
  the project by change request. See [Marketplace](/docs/feature-flags/marketplace).
