...
| `spaces` | Spaces | Experimental | Off | `routes` |
...
- **`spaces`** — group sessions under a named effort inside the project, each
  with its own default agent, scheduled work, and grants. Declared in
  `kortix.yaml` under `spaces:`. See
