...
<Cards>
  ...
  <Card icon={<PackageIcon />} title="Subprojects" href="/docs/feature-flags/subprojects">Install a Kortix project into another project, activate its triggers, and read its runs.</Card>
</Cards>
...
- **`subprojects`** — install a subproject (a GitHub repo whose `kortix.yaml` declares
  agents, skills, connectors and triggers) into a project, and read the run
  history of the triggers it owns. See [Subprojects](/docs/feature-flags/subprojects).
