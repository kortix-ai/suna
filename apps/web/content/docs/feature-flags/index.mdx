...
import { BrowserIcon, KanbanIcon } from '@/lib/icons/ssr';
...
<Cards>
  ...
  <Card icon={<KanbanIcon />} title="Monitoring" href="/docs/feature-flags/monitoring">A stage board over every session you can see, plus each trigger's runs.</Card>
</Cards>
