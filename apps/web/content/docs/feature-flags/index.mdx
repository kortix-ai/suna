...
<CardGroup>
  ...
  <Card icon="store" title="Templates" href="/docs/feature-flags/templates">
...
| ------------------------- | ----------------------- | ------------ | ----------------------------- | ------------ |
| `templates`               | Templates               | Experimental | Off                           | `routes`     |
...
- **`templates`** — browse the template catalog and install a template into
  the project by change request. See [Templates](/docs/feature-flags/templates).
