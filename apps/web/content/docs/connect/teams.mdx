...
they rotate on rate limits. The choice applies to your next message; the chat
keeps its session. A personal chat whose session started before sessions there
