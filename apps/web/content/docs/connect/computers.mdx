...
1. Add **Computer Tunnel** from the workspace connector catalog.
...
Pairing adds a machine to your account fleet. It does not grant workspace access.
Add **Computer Tunnel** from the workspace [connector](/docs/connect/connectors)
