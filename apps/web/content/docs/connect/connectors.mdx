...
Open the connector in **Customize → Connectors**, then select **Share** on the
account row. The dialog is the same **Grant access** dialog used for agents. It
lists who can use the account now, and you add:
