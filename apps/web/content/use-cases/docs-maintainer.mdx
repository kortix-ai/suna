...
description: The docs agent we run on Kortix — connected to GitHub and our codebase. When a PR merges, it updates the docs the change affected and opens a PR for review.
date: "2026-07-05"
author: team
tags:
  - Documentation
...
merge. This writes up how we run that on Kortix — the connections, the steps, and
...
On Kortix, every merge to our repo triggers an agent. Each merged PR runs in its
