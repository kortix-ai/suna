        ...
        <ContextMenuContent className="w-48">
          ...
          {!isDir && (
            <ContextMenuItem onClick={() => {
              ...
              <ExternalLink className="mr-2 h-4 w-4" />{tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line342JsxTextOpenInNewTab')}</ContextMenuItem>
          )}
          {!isDir && (
          ...
          {!isDir && (
            <ContextMenuItem onClick={() => filesStore.getState().openHistory(node.path)}>
              <History className="mr-2 h-4 w-4" />{tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line367JsxTextViewHistory')}</ContextMenuItem>
          )}
          {isDir && (
            <>
              <ContextMenuSeparator />
              <ContextMenuItem onClick={() => onCreateInDir(node.path, 'file')}>
                <FilePlus className="mr-2 h-4 w-4" />{tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line375JsxTextNewFile')}</ContextMenuItem>
              <ContextMenuItem onClick={() => onCreateInDir(node.path, 'folder')}>
                <FolderPlus className="mr-2 h-4 w-4" />{tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line379JsxTextNewFolder')}</ContextMenuItem>
              <ContextMenuItem onClick={() => onUploadToDir(node.path)}>
                <Upload className="mr-2 h-4 w-4" />{tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line383JsxTextUploadFile')}</ContextMenuItem>
            </>
          )}
          <ContextMenuSeparator />
          ...
          <ContextMenuItem onClick={() => navigator.clipboard.writeText(node.path)}>
            <Copy className="mr-2 h-4 w-4" />{tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line398JsxTextCopyPath')}</ContextMenuItem>
          <ContextMenuSeparator />
          <ContextMenuItem onClick={() => {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between px-3 py-2 shrink-0">
        ...
        <div className="flex items-center gap-0.5">
          <Button variant="ghost" size="icon" className="h-6 w-6" onClick={() => { setNewFileName('untitled.txt'); setIsCreatingFile(true); }} title={tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line912JsxAttrTitleNewFile')}>
            <FilePlus className="h-3.5 w-3.5" />
          </Button>
          <Button variant="ghost" size="icon" className="h-6 w-6" onClick={() => { setNewFolderName('New Folder'); setIsCreatingFolder(true); }} title={tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line915JsxAttrTitleNewFolder')}>
      ...
      <div className="flex items-center gap-1 px-2 pb-1.5 shrink-0">
        {currentPath !== '/workspace' && (
          <Button
            ...
            title={tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line936JsxAttrTitleBackToWorkspace')}
        ...
        {pathInputActive ? (
          ...
          <button
            ...
            title={tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line964JsxAttrTitleClickToNavigateToPath')}
            onClick={() => {
      ...
      <AlertDialog open={!!deleteTarget} onOpenChange={() => setDeleteTarget(null)}>
        ...
        >
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>{tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line1054JsxTextAreYouSureYouWantToDelete')}<span className="font-semibold text-foreground">{tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line1054JsxTextQuot')}{deleteTarget?.name}{tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line1054JsxTextQuotec1ca351')}</span>{tHardcodedUi.raw('featuresProjectFilesComponentsFileTree.line1054JsxTextThisActionCannotBeUndone')}</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
