...
export function FileBrowser() {
  ...
  // Download a file — file-browser is not mounted on /projects/* so we
  // short-circuit to avoid threading project context through this legacy
  // component. The download invocation is left as a stub.
              ...
              <div className="min-h-full p-1.5">
                ...
                {fileItems.map((node) => (
                  <FileTreeItem
                    ...
                    node={node}
                    getIcon={getFileIcon}
                    historyLabel={tHardcodedUi.raw('featuresProjectFilesComponentsFileTreeItem.line322JsxTextCheckpointHistory')}
                    onClick={() => handleFileClick(node)}
