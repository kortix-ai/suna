...
const LANDING_COPY = {
  ...
  line331JsxTextGiveYourCompanyAWorkforce: 'Own your first internal agent.',
  line334JsxTextFreeToSelfHostManagedCloudFrom20: [
    'Open source, self-hostable',
    'Deploy to Slack in minutes',
    'Your data, config, and model',
  ],
  ...
  heroCommandCenter: 'Open internal agents,',
  heroAiWorkforce: 'built from code.',
  heroDescription:
    'Own the config, tools, skills, and runtime. Deploy on cloud, self-host, or share as a template.',
  startBuildingCta: 'Start building',
  workLoopEyebrow: 'Open by default',
  workLoopTitle: 'No black box agents.',
  workLoopDescription:
    'Kortix turns agent behavior into files your team can inspect, diff, fork, and deploy anywhere.',
  ...
  splitTitle: 'Cloud or self-hosted.',
  ...
  differentScreenEyebrow: 'Not another closed agent',
  differentScreenSectionTitle: 'Build on open standards.',
  differentScreenSectionDescription:
    'Agents are config, prompts, skills, and tools. The project stays portable by design.',
  companyAsCodeEyebrow: 'Just code',
  companyAsCodeTitle: 'Everything is code you own.',
  companyAsCodeDescription:
    'No hidden builder state. Grep the agent, review the diff, and keep the project yours.',
  ...
  integrationsDescription:
    'Use scoped access for Slack, APIs, MCP servers, REST endpoints, and internal tools.',
  ...
  splitDescription:
    'Run managed cloud when speed matters. Move to your own infra when control matters.',
  workforceMapEyebrow: 'Built to be portable',
  workforceMapTitle: 'Open standards, no lock-in.',
  workforceMapDescription:
    'Build once, run on cloud, self-hosted infra, VPC, or an open marketplace.',
