...
const LANDING_COPY = {
  ...
  line149JsxTextTalkToSales: 'See repo',
  ...
  line331JsxTextGiveYourCompanyAWorkforce: 'Deploy the agent you already use.',
  ...
  heroCommandCenter: 'Code. Deploy.',
  heroAiWorkforce: 'Connect Slack.',
  heroDescription:
    'Package your local agent workflow as a Kortix project and ship it to your team in minutes.',
  startBuildingCta: 'Deploy agent',
  workLoopEyebrow: 'Deploy path',
  workLoopTitle: 'From config to live agent.',
  workLoopDescription:
    'Start with the coding agent you trust locally. Deploy the same workflow where your team works.',
  ...
  splitTitle: 'Build first. Scale later.',
  ...
  differentScreenEyebrow: 'Local to live',
  differentScreenSectionTitle: 'One flow, every surface.',
  differentScreenSectionDescription:
    'Develop locally, deploy to the cloud runtime, and reach teammates from Slack.',
  companyAsCodeEyebrow: 'Just code',
  companyAsCodeTitle: 'Configure. Version. Deploy.',
  companyAsCodeDescription:
    'Keep the agent in git, review every change, and redeploy when the workflow evolves.',
  ...
  integrationsTitlePrefix: 'Start in Slack,',
  integrationsTitle: 'wire up the rest.',
  ...
  splitDescription: 'One project format works for a solo builder, a team, or a production rollout.',
  workforceMapEyebrow: 'Runtime map',
  workforceMapTitle: 'One deploy, many endpoints.',
  workforceMapDescription:
    'Your agent runs in a sandbox, connects to Slack, and reaches the tools it needs.',
