  ...
  return (
    <div className="bg-background flex h-full flex-col">
      ...
      >
        ...
        <ChatBubble name="dosco" app avatar={<doscoAvatar />}>
          {active.reply}
        </ChatBubble>
      </div>
 ...
 *  on screen is output the CLI produced against dev-api.dosco.live. The grid is
  ...
  return (
    <div className="w-full">
      {/* The frame is shorter than the 16:10 recording and anchored to the top,
          ...
          the dosco reply could not both be on screen. */}
