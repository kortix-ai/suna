...
import type { SubprojectRunStatus } from '@kortix/sdk';
 ...
 * subproject run cannot have and are not listed.
 *
 ...
 */
const LEGEND_STATUSES: readonly { status: SubprojectRunStatus; label: string }[] = [
 ...
 */
export function SubprojectRunLegend({ className }: { className?: string }) {
  return (
