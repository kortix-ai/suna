 ...
 * boundary) and `WorkspaceFilesView`'s pre-ref state, so the two can never
 * disagree about layout and the paint does not shift as one hands over to the
 * other.
 *
 * Deliberately imports nothing from `@/features/workspace-files` (9,291 LOC) or
 ...
 */
export function WorkspaceFilesSkeleton() {
  return (
    <div className="bg-background flex h-full flex-col" data-slot="workspace-files-skeleton">
