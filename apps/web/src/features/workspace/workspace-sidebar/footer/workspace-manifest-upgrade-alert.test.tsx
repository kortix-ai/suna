...
import { WorkspaceManifestUpgradeAlertView } from './workspace-manifest-upgrade-alert';
...
function render(props: {
  ...
  return renderToStaticMarkup(
    <SidebarProvider defaultOpen>
      <WorkspaceManifestUpgradeAlertView {...props} />
    </SidebarProvider>,
  );
}

describe('WorkspaceManifestUpgradeAlertView — v1/v2 visibility', () => {
  ...
  test('renders nothing at all once the workspace is on v2 (or the viewer cannot act)', () => {
...
describe('WorkspaceManifestUpgradeAlertView — click wiring', () => {
