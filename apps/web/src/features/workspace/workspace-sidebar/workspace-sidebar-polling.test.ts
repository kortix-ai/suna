...
const sandboxSource = readFileSync(
  join(import.meta.dir, 'footer/workspace-sandbox-alert.tsx'),
  'utf8',
);
const changeRequestSource = readFileSync(
  join(import.meta.dir, 'footer/workspace-change-requests-nav.tsx'),
  'utf8',
);
...
describe('workspace sidebar polling', () => {
