        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          <ModalBody className="max-h-[60vh] space-y-4 overflow-y-auto">
            ...
            {strategy === 'broker' && (
              <div className="border-border bg-sidebar space-y-4 rounded-md border p-3">
                <div className="space-y-1">
                  <p className="text-sm font-medium">dosco service</p>
                  <p className="text-muted-foreground text-xs">
                ...
                <Field>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem
                        value="llm_gateway"
                        description="dosco sends model requests. The sandbox receives no key."
                      >
                        LLM gateway
                      </SelectItem>
                      <SelectItem
                        value="http_broker"
                        description="dosco adds the value to one approved HTTPS destination."
                      >
                        HTTPS broker
                      </SelectItem>
                      <SelectItem
                ...
                {brokerConsumer === 'http_broker' && (
                  <>
                    <InfoBanner tone="neutral" title="Opaque sandbox handle">
                      The sandbox receives a session handle. dosco adds the real value only to a
                    ...
                    <Field>
                      ...
                      />
                      <FieldDescription>
                        One exact host or leading wildcard per line. dosco denies every other host.
                      </FieldDescription>
                    </Field>
                    ...
                    {injectionKind === 'header' && (
                      <Field>
                        ...
                        />
                        <FieldDescription>
                          Optional. Include {'{{secret}}'} where dosco inserts the value. Leave it
