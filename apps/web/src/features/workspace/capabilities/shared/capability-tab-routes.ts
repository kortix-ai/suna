 ...
 * Review on `review_center`, Templates on `templates`.
...
export const CAPABILITY_TABS: readonly CapabilityTab[] = [
  ...
  // Templates installs the four tabs above it — a template delivers agents,
  ...
  { key: 'templates', label: 'Templates', flag: 'templates' },
