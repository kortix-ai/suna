...
/**
 * File mutations — read-only stubs for workspace-files.
 *
 ...
 * "Workspace files are read-only in this view" and refuses.
 */

const READ_ONLY_MSG = 'Workspace files are read-only in this view';
