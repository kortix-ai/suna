...
/**
 * The action button on `/templates/<slug>` — split out from
 ...
 *    page>?install=1`. `/templates` is a signup-safe return prefix
 ...
 *    `createTemplateInstallSession` call the in-project install modal
