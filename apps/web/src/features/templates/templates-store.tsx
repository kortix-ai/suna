...
import { qk, useTemplateInstall, useTemplateCatalog } from '@kortix/sdk/react';
...
/**
 * The project-scoped templates — the **Templates** capability tab at
 * `/projects/[id]/customize/templates`.
 *
 ...
 * it is the uninstall. A template catalog is where you get things, not where you
 ...
 */
export function TemplatesStore({ projectId }: { projectId: string }) {
  ...
  return (
    ...
    <div className="min-h-0 flex-1 overflow-y-auto">
      <div
        data-templates-store
        className="mx-auto w-full max-w-5xl space-y-8 px-4 py-10 pb-20 lg:py-14"
      >
        <header className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-1">
            <h1 className="text-foreground text-xl font-medium text-balance">Templates</h1>
        ...
        <div className="space-y-4">
          ...
          {catalog.isLoading ? (
            ...
            <ErrorState
              size="sm"
              title="Could not load the template catalog"
