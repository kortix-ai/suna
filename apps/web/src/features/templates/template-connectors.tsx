...
import type { TemplateConnectorRow } from './templates-catalog';
...
/**
 * What a template plugs into, and whether THIS project already has it.
 *
 * The list is the template's REQUIREMENTS, read from its `kortix.yaml`. The
...
export function TemplateConnectors({
  ...
  connectors: TemplateConnectorRow[];
  /**
    ...
    <section className="space-y-2">
      ...
      <ul className="bg-popover overflow-hidden rounded-md border">
        {connectors.map((use, index) => {
          ...
          // named after its app rather than after the template's alias.
