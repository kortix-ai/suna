          ...
          <div className="flex items-center gap-2 border-b px-3">
            ...
            <Input
              ...
              placeholder={tHardcodedUi.raw(
                'featuresFilesComponentsFileSearch.line109JsxAttrPlaceholderSearchFiles',
              )}
            ...
            <button
              ...
              aria-label={tI18nHardcoded.raw(
                'autoFeaturesFilesComponentsFileSearchJsxAttrAriaLabelClose93fc5ea3',
              )}
          ...
          <div ref={listRef} className="max-h-[300px] overflow-y-auto">
            {debouncedQuery.length === 0 && (
              <div className="text-muted-foreground px-4 py-6 text-center text-sm">
                {tHardcodedUi.raw(
                  'featuresFilesComponentsFileSearch.line124JsxTextTypeToSearchFiles',
                )}
              </div>
            )}
            ...
            {results && results.length === 0 && debouncedQuery.length > 0 && (
              <div className="text-muted-foreground px-4 py-6 text-center text-sm">
                {tHardcodedUi.raw('featuresFilesComponentsFileSearch.line136JsxTextNoFilesFound')}
              </div>
            )}
