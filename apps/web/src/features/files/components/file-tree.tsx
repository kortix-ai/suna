        ...
        <ContextMenuContent className="w-48">
          ...
          {!isDir && (
            <ContextMenuItem onClick={() => filesStore.getState().openHistory(node.path)}>
              ...
              {tHardcodedUi.raw('featuresFilesComponentsFileTree.line367JsxTextViewHistory')}
            </ContextMenuItem>
          )}
          {isDir && (
            <>
              ...
              <ContextMenuItem onClick={() => onCreateInDir(node.path, 'file')}>
                ...
                {tHardcodedUi.raw('featuresFilesComponentsFileTree.line375JsxTextNewFile')}
              </ContextMenuItem>
              <ContextMenuItem onClick={() => onCreateInDir(node.path, 'folder')}>
                <FolderPlus className="mr-2 h-4 w-4" />
                {tHardcodedUi.raw('featuresFilesComponentsFileTree.line379JsxTextNewFolder')}
              </ContextMenuItem>
              <ContextMenuItem onClick={() => onUploadToDir(node.path)}>
                <Upload className="mr-2 h-4 w-4" />
                {tHardcodedUi.raw('featuresFilesComponentsFileTree.line383JsxTextUploadFile')}
              </ContextMenuItem>
            </>
          )}
          <ContextMenuSeparator />
          ...
          <ContextMenuItem onClick={() => navigator.clipboard.writeText(node.path)}>
            ...
            {tHardcodedUi.raw('featuresFilesComponentsFileTree.line398JsxTextCopyPath')}
          </ContextMenuItem>
          <ContextMenuSeparator />
          <ContextMenuItem
            onClick={() => {
      ...
      <div className="flex shrink-0 items-center justify-between px-3 py-2">
        ...
        <div className="flex items-center gap-0.5">
          <Button
            ...
            title={tHardcodedUi.raw('featuresFilesComponentsFileTree.line912JsxAttrTitleNewFile')}
          >
          ...
          <Button
            ...
            title={tHardcodedUi.raw('featuresFilesComponentsFileTree.line915JsxAttrTitleNewFolder')}
          >
      ...
      <div className="flex shrink-0 items-center gap-1 px-2 pb-1.5">
        {currentPath !== '/workspace' && (
          <Button
            ...
            title={tHardcodedUi.raw(
              'featuresFilesComponentsFileTree.line936JsxAttrTitleBackToWorkspace',
            )}
        ...
        {pathInputActive ? (
          ...
          <button
            ...
            title={tHardcodedUi.raw(
              'featuresFilesComponentsFileTree.line964JsxAttrTitleClickToNavigateToPath',
            )}
            onClick={() => {
      ...
      <AlertDialog open={!!deleteTarget} onOpenChange={() => setDeleteTarget(null)}>
        ...
        >
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {tHardcodedUi.raw(
                'featuresFilesComponentsFileTree.line1054JsxTextAreYouSureYouWantToDelete',
              )}
              <span className="text-foreground font-semibold">
                {tHardcodedUi.raw('featuresFilesComponentsFileTree.line1054JsxTextQuot')}
                {deleteTarget?.name}
                {tHardcodedUi.raw('featuresFilesComponentsFileTree.line1054JsxTextQuot46a46963')}
              </span>
              {tHardcodedUi.raw(
                'featuresFilesComponentsFileTree.line1054JsxTextThisActionCannotBeUndone',
              )}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
