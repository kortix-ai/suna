...
import { agoLabel } from './craft-runs';

/**
 * The relative-time column shared by every craft-run list: the project-home
 * preview, the run index, and one craft's run history.
 *
...
/**
 * A craft run's age, with the instant it stands for on hover.
 *
 ...
 * the craft's install date — so the tooltip NAMES what is being measured, and
