...
import { EMPTY_PLATFORM_AGENT_NAMES } from './composer/agent-selector';
...
// e.g. `channels-view.tsx`, `schedule-view.tsx`). The platform-agent
// elevation (R-37) moved with it — see that file.
