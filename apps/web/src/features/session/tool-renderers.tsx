...
import { DangerTriangle as AlertTriangle, Ban, BookOpen, Sparkles as Brain, Calendar as CalendarClock, Check, CheckCircle, ChevronDown, ChevronRight, Circle, DangerCircle as CircleAlert, ClockCircle as Clock, Code as Code2, Microchip as Cpu, ExternalLink, File as FileCode2, File as FileIcon, FileText, Key as Fingerprint, Folder, Glasses, Globe, Hash, Image as ImageIcon, LayersOne as Layers, ListCheck as ListTodo, List as ListTree, Spinner as Loader2, Maximize as Maximize2, Chat as MessageCircle, Minimize as Minimize2, Monitor as MonitorPlay, Music, PanelRight, Power as Plug, Plus, Presentation, Refresh as RefreshCw, Scissors, Search, SquareKanban, StopCircle, Tag as Tags, Terminal, TrashSolid as Trash2, TypeText as Type, Video, X } from '@mynaui/icons-react';
...
// ============================================================================
// ToolCode — flush, headerless highlighted code body
// ============================================================================
// The canonical way to show full file contents inside a tool body (write,
// morph_edit, show). Deliberately flush: no inner card, no language pill, no
// copy bar — that nested chrome made `write` look heavier than `edit`/`read`.
