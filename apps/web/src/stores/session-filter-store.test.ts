...
// --- Deprecated scalar API (filterByProject / setFilter / statusByProject /
// setStatusFilter) — restored verbatim from d99b65616a. This API is still
// imported and called by project-sidebar.tsx today; it is NOT dead code.
// These tests stay until the task that deletes setFilter/setStatusFilter
// removes them too — do not weaken, merge, or "modernize" them.
