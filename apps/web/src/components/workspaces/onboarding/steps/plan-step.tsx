...
/**
 * `workspaceId` is passed explicitly, never inferred. `useModelConnectionGate`
...
export function PlanStep({
   ...
   * unguardable: dropping `workspaceId={workspaceId}` at the single call site
  ...
  const { openConnectProvider, openUpgrade, modal, hasSelectableModels, showUpgradeOption } =
    useModelConnectionGate(flattenModels(providers), { workspaceId });
