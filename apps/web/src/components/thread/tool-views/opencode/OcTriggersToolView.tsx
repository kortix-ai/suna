  ...
  return (
    <div className="flex items-center gap-2.5 px-3 py-2 rounded-2xl border border-border/50 bg-foreground/[0.02]">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-sm font-medium text-foreground truncate tracking-tight">{t.name}</div>
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        <span className="inline-flex items-center gap-1.5 text-xs text-muted-foreground/70 tracking-tight">
          <span
            className={cn(
    ...
    <ScrollArea className="h-full w-full">
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-2xl border border-border/50 bg-foreground/[0.02]">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-medium text-foreground tracking-tight truncate">{name}</div>
            {id && (
              <div className="text-xs text-muted-foreground/60 font-mono truncate">{id}</div>
            )}
          </div>
        ...
        {args.prompt && (
          <div className="space-y-1">
            <div className="text-xs uppercase tracking-wider text-muted-foreground font-medium">Prompt</div>
