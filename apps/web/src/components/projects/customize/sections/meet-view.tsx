...
export function MeetView({ projectId }: { projectId: string }) {
  ...
  return (
    <div className="bg-background flex h-full min-h-0 flex-col">
      <CustomizeSectionHeader icon={AudioLines} title="Meetings" />

      <div className="min-h-0 flex-1 overflow-y-auto">
        <div className="mx-auto w-full max-w-3xl space-y-6 px-4 py-8">
          <header className="space-y-1.5">
            <h2 className="text-foreground text-base font-semibold">Meetings</h2>
            <p className="text-muted-foreground text-sm">
              The notetaker bot joins your calls — Google Meet, Zoom, or Microsoft Teams —
              transcribes with speaker labels, and answers out loud when addressed. Choose the voice
              it speaks in.
            </p>
          </header>
          ...
          <SectionCard
            title="Bot name"
            description="The display name the notetaker joins under. People wake it in the call by saying its first name (e.g. say its name and a request)."
          >
