...
export const SETTLED: {
  ...
  projects: [
    ...
    // A few other shipped projects so the Projects list reads full and lived-in.
    { name: 'growth-loop', status: 'live', files: 14, branch: 'main' },
    { name: 'support-bot', status: 'live', files: 11, branch: 'main' },
    { name: 'finance-close', status: 'draft', files: 7, branch: 'main' },
  ],
