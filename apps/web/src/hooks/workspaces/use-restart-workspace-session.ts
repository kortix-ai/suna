...
import { restartWorkspaceSession, sessionStartKey } from '@kortix/sdk';
 ...
 */
export function useRestartWorkspaceSession(workspaceId: string, sessionId: string) {
  const queryClient = useQueryClient();
  const startKey = sessionStartKey(workspaceId, sessionId);
