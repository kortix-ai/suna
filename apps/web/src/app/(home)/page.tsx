          ...
          <motion.div className="relative z-[1] flex flex-col h-full" style={{ opacity: heroOpacity, scale: heroScale }}>
            <div className="flex-1 flex flex-col items-center justify-center px-6 pt-24 text-center pointer-events-none">
              <a
                ...
                className="pointer-events-auto group mb-6 inline-flex max-w-full items-center gap-2 rounded-full border border-border bg-background/70 py-1 pl-1.5 pr-3 text-xs text-muted-foreground backdrop-blur-sm transition-colors hover:border-foreground/20 hover:text-foreground"
              >
                <span className="inline-flex shrink-0 items-center gap-1.5 whitespace-nowrap rounded-full bg-foreground/[0.06] px-2 py-0.5 font-medium text-foreground">
                ...
                <span className="min-w-0 truncate">
                  <span className="sm:hidden">Self-host anywhere</span>
                  <span className="hidden sm:inline">Self-host anywhere — own it end to end</span>
                </span>
            ...
            <div className="relative z-[1] pb-8 px-4 flex flex-col items-center gap-6">
              ...
              <button
                onClick={copyInstall}
                className="group flex max-w-full items-center gap-2.5 h-9 px-4 rounded-full bg-background/70 border border-border hover:bg-background/90 hover:border-foreground/20 transition-colors cursor-pointer animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 fill-mode-both backdrop-blur-sm"
              >
                <span className="shrink-0 font-mono text-[11px] text-muted-foreground select-none">$</span>
                <code className="overflow-x-auto whitespace-nowrap text-[11px] font-mono text-foreground tracking-tight [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">{installCmd}</code>
                <div className="shrink-0 pl-2.5 border-l border-border">
                  {copied
