          ...
          <Reveal delay={0.1}>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div
                  key={titleKey}
                  className="group border-border bg-card hover:bg-background flex h-full w-full flex-col justify-between gap-4 rounded-sm border p-4 transition md:aspect-[283/200]"
                >
                  <div className="bg-secondary group-hover:bg-card self-start rounded-lg p-2.5">
                    <Icon className="text-foreground size-5 shrink-0" />
                  </div>
