          ...
          <div className="relative z-10 pt-20 sm:pt-24 md:pt-32 mx-auto h-full w-full max-w-6xl flex flex-col items-center justify-center min-h-[60vh] sm:min-h-0">
            <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 pt-12 sm:pt-20 max-w-4xl mx-auto pb-6 sm:pb-7">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 border border-primary/10">
                ...
                <span className="text-sm font-medium text-primary">{tHardcodedUi.raw('appHomeMilanoPage.line92JsxTextMilanoItaly')}</span>
              </div>
              ...
              <div className="text-center space-y-2 max-w-3xl px-4">
                <h2 className="text-lg sm:text-xl md:text-2xl font-medium tracking-tight text-muted-foreground">{tHardcodedUi.raw('appHomeMilanoPage.line101JsxTextIlTuoWorkerIaAutonomo')}</h2>
                <p className="text-sm sm:text-base text-muted-foreground/80 font-normal text-balance leading-relaxed">{tHardcodedUi.raw('appHomeMilanoPage.line104JsxTextCostruitoPerCompitiComplessiProgettatoPerTuttoL')}</p>
              </div>
              ...
              <div className="flex flex-col items-center w-full max-w-3xl mx-auto gap-2 flex-wrap justify-center px-4 sm:px-0">
                <div className="w-full relative">
                  <SessionChatInput
                    ...
                    placeholder={tHardcodedUi.raw('appHomeMilanoPage.line113JsxAttrPlaceholderDescriviIlTuoCompito')}
