...
export default function DevelopersPage() {
  ...
  return (
    <div className="bg-background relative w-full">
      ...
      <section className="flex flex-col gap-10 px-6 py-16 sm:gap-12 sm:py-24">
      ...
      {/* <section className="mx-auto flex max-w-6xl flex-col gap-10 px-6 py-16 sm:gap-12 sm:py-24">
        <Reveal>
          <div className="mb-8 max-w-2xl">
            ...
            <p className="text-muted-foreground mt-4 text-base leading-relaxed">
              Kortix is source-available — read it, fork it, audit every line. Self-host the exact
              same stack on a laptop, a VPS, your VPC, or fully air-gapped.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.05}>
          <a
            ...
            className="group border-border bg-card hover:border-foreground/30 flex items-center gap-4 rounded-sm border p-5 transition-colors"
          >
            <span className="border-border bg-muted/40 flex size-11 shrink-0 items-center justify-center rounded-lg border">
              <svg
                viewBox="0 0 24 24"
            ...
            <div className="min-w-0 flex-1">
              <div className="text-foreground text-sm font-semibold">
                kortix-ai/suna · <span className="tabular-nums">{formattedStars}</span> stars
              </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          {RUNS_ANYWHERE.map(({ icon: Icon, title, desc }, i) => (
            <Reveal key={title} delay={i * 0.06}>
              <div className="group border-border bg-card hover:bg-background flex h-full flex-col gap-3 rounded-sm border p-5 shadow-sm transition-colors">
                <div className="flex items-center gap-3">
                  <span className="bg-secondary group-hover:bg-card flex size-8 shrink-0 items-center justify-center rounded-lg transition-colors">
                    <Icon className="text-foreground size-4" />
                  </span>
