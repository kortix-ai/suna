      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        <div className="mx-auto flex h-full w-full max-w-3xl flex-col justify-center px-4 py-10">
          <div className="rounded-lg border border-border/70 bg-card p-6">
            <p className="text-sm font-medium text-foreground">Connectors are being rebuilt.</p>
            <p className="mt-1 text-sm text-muted-foreground">
              The legacy Pipedream connector implementation has been removed from the API. This entry stays here as the landing point for the replacement.
            </p>
          </div>
        </div>
      </div>
