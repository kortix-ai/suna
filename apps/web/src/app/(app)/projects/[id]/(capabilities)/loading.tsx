 ...
 * /projects/[id]/{agent,connectors,skills,schedules,webhooks}.
 *
 * One file covers every one of them: `(capabilities)` is a route group whose
 ...
 *     ProjectCustomizeNavItem has nothing to store — every click would pay the
