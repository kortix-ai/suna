...
/**
 * `/templates/<slug>` — one template, for search.
 *
 * The page exists because `/templates` alone gives a crawler one URL for the
...
export async function generateMetadata(props: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    ...socialMetadata(`${template.title} — Kortix Templates`, description, url),
  };
}
