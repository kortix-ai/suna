...
export const KORTIX_API_ORIGIN = 'https://api.dosco.live/v1';
...
dosco does not publish dynamic OAuth client registration. Contact dosco support to provision an OAuth client.
...
export const AI_CATALOG = {
  ...
  entries: [
    {
      identifier: 'urn:air:dosco.live:mcp:public-content',
