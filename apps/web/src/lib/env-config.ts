...
function readRawEnv(): Partial<RuntimeEnv> {
  ...
  return {
    ...
    WEBHOOK_BASE_URL:
      ...
      process.env.KORTIX_URL,
    BILLING_ENABLED:
      (process.env.KORTIX_PUBLIC_BILLING_ENABLED || process.env.NEXT_PUBLIC_BILLING_ENABLED) ===
      'true',
    MANAGED_PROVIDER_ENABLED:
      (process.env.KORTIX_PUBLIC_MANAGED_PROVIDER_ENABLED ||
        process.env.NEXT_PUBLIC_MANAGED_PROVIDER_ENABLED) === 'true',
    CONNECTORS_ENABLED:
      (process.env.KORTIX_PUBLIC_CONNECTORS_ENABLED ||
        process.env.NEXT_PUBLIC_CONNECTORS_ENABLED) !== 'false',
    DISABLE_LANDING_PAGE:
      (process.env.KORTIX_PUBLIC_DISABLE_LANDING_PAGE ||
        process.env.NEXT_PUBLIC_DISABLE_LANDING_PAGE) === 'true',
    RESTRICT_ACCOUNT_CREATION:
      (process.env.KORTIX_PUBLIC_RESTRICT_ACCOUNT_CREATION ||
        process.env.NEXT_PUBLIC_RESTRICT_ACCOUNT_CREATION) === 'true',
    APP_URL:
    ...
    SANDBOX_ID:
      process.env.KORTIX_PUBLIC_SANDBOX_ID || process.env.NEXT_PUBLIC_SANDBOX_ID || undefined,
    AUTH_PROVIDERS:
