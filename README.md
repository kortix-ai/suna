...
[![Twitter Follow](https://img.shields.io/twitter/follow/adentic)](https://x.com/adentic)
[![GitHub Repo stars](https://img.shields.io/github/stars/adentic/adentic)](https://github.com/adentic/adentic)
[![Issues](https://img.shields.io/github/issues/adentic/adentic)](https://github.com/adentic/adentic/labels/bug)
...
```bash
git clone https://github.com/adentic/adentic.git
cd adentic
```
